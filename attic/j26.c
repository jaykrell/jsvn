...
static const char sourcefile[] = "j25.c";
...
{
    jk_dump_long(t, buffer_size, buffer, (long)data);
}

void jk_dump_unsigned_int(size_t buffer_size, char * buffer, unsigned int data)
{
    jk_dump_unsigned_long(t, buffer_size, buffer, (unsigned long)data);
}
...
void jk_type_dump_char(jk_type *, size_t buffer_size, char * buffer, void * data)
{
}
...
long
jk_type_copy_n_copy_memory(jk_type_t * type, void * to, const void * from, size_t n)
{
...
long
jk_type_move_n_copy_memory(jk_type_t * type, void * to, void * from, size_t n)
{
...
long
jk_type_move_n_copy_memory_and_zero_memory(jk_type_t * type, void * to, void * from, size_t n)
{
...
long
jk_type_construct_n_zero_memory(jk_type_t * type, void * p, size_t n)
{
...
long
jk_type_construct_n_do_nothing(jk_type_t * type, void * p, size_t n)
{
    jk_unused(type);
    jk_unused(p);
    jk_unused(&n);
...
void
jk_type_destroy_n_do_nothing(jk_type_t * type, void * p, size_t n)
{
    jk_unused(type);
    jk_unused(p);
    jk_unused(&n);

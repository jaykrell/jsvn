...
jk_macosx_get_main_display(&display);
...
jk_printf(
	...
	"bits_per_pixel 0x%x "
	"bytes_per_row 0x%x "
	"bits_per_sample 0x%x "
	"samples_per_pixel 0x%x "
	"can_set_palette 0x%x "
	"palette %p "
	"\n",
	display.id,
	display.base_address,
	display.pixels_wide,
	display.pixels_high,
	display.bits_per_pixel,
	display.bytes_per_row,
	display.bits_per_sample,
	display.samples_per_pixel,
	display.can_set_palette,
	display.palette
	);
	
	jk_macosx_release_display(&display);
	jk_macosx_release_display(&display);

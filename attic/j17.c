...
const static char sourcefile[] = "j15.c";
...
const jk_profile_count_function_calls_map_entry_t jk_profile_count_function_calls_map[] =
{
	...
	{ jk_make_seven_bit_constant_string("jk_file_open_for_read"), jk_offsetof_field(jk_profile_count_function_calls_t, jk_file_open_for_read) },
	{ jk_make_seven_bit_constant_string("jk_file_close"), jk_offsetof_field(jk_profile_count_function_calls_t, jk_file_close) },
	{ jk_make_seven_bit_constant_string("jk_file_read_ahead"), jk_offsetof_field(jk_profile_count_function_calls_t, jk_file_read_ahead) },
	{ jk_make_seven_bit_constant_string("jk_file_read_copy"), jk_offsetof_field(jk_profile_count_function_calls_t, jk_file_read_copy) },
	{ jk_make_seven_bit_constant_string("jk_file_read_get_buffer"), jk_offsetof_field(jk_profile_count_function_calls_t, jk_file_read_get_buffer) },
};
...
{
    jk_make_pack_spec(jk_java_packed_classfile1_t, jk_java_classfile_t, magic, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile1_t, jk_java_classfile_t, minor_version, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile1_t, jk_java_classfile_t, major_version, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile1_t, jk_java_classfile_t, constant_pool_count, jk_endian_big, t_void),
};
...
{
    jk_make_pack_spec(jk_java_packed_classfile2_t, jk_java_classfile_t, access_flags, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile2_t, jk_java_classfile_t, this_class, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile2_t, jk_java_classfile_t, super_class, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile2_t, jk_java_classfile_t, interfaces_count, jk_endian_big, t_void),
};
...
{
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, magic, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, minor_version, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, major_version, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, constant_pool_count, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, access_flags, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, this_class, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, super_class, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, interfaces_count, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, fields_count, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, methods_count, jk_endian_big, t_void),
    jk_make_pack_spec(jk_java_packed_classfile3_t, jk_java_classfile_t, attributes_count, jk_endian_big, t_void),
};
#endif

JK_EXTERN_CONST jk_fields_t jk_fields =
{
    /* java_classfile */
    {
        {
...
{
	const static char function[] = "jk_java_convert_java_double_to_native_double";
...
{
	const static char function[] = "jk_java_convert_java_float_to_native_float";
    long sign;
    long exponent;
    long mantissa;
    unsigned long i;
...
#pragma unused(ppcf)
    ...
    jk_dump_struct(globals, "classfile.", &classfile, &jk_java_packed_classfile_type_info); 
...
const jk_fields_t  jk_fields;
const jk_types_t   jk_types;
jk_globals_t jk_globals = { &jk_fields, &jk_types };

int main(int argc, char ** argv)
{    
    if (argc > 1 && argv && argv[1])
    {
    	jk_java_read_classfile(&jk_globals, 0, argv[1]);

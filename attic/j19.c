...
/*
jk_profile_count_function_calls_map_entry_t jk_profile_count_function_calls_map[] =
{
	{ jk_make_profile_function_name_string(""), 0 },
	{ jk_make_profile_function_name_string("jk_compute_packed_size"), offsetof(jk_profile_count_function_calls_t, jk_compute_packed_size) },
	{ jk_make_profile_function_name_string("jk_compute_packed_or_unpacked_size"), jk_indexof_field(jk_profile_count_function_calls_t, jk_compute_packed_or_unpacked_size) },
	{ jk_make_profile_function_name_string("jk_compute_unpacked_size"), jk_indexof_field(jk_profile_count_function_calls_t, jk_compute_unpacked_size) },
	{ jk_make_profile_function_name_string("jk_file_close"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_close) },
	{ jk_make_profile_function_name_string("jk_file_open_for_read"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_open_for_read) },
	{ jk_make_profile_function_name_string("jk_file_read_ahead"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_read_ahead) },
	{ jk_make_profile_function_name_string("jk_file_read_and_unpack"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_read_and_unpack) },
	{ jk_make_profile_function_name_string("jk_file_read_copy"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_read_copy) },
	{ jk_make_profile_function_name_string("jk_file_read_get_buffer"), jk_indexof_field(jk_profile_count_function_calls_t, jk_file_read_get_buffer) },
	{ jk_make_profile_function_name_string("jkp_file_read_direct"), jk_indexof_field(jk_profile_count_function_calls_t, jkp_file_read_direct) },
};
*/
jk_seven_bit_constant_string_t jk_profile_count_function_calls_names[] =
{
...
{
    jk_profile_count_function_calls_map_entry_t const * map = 0;
    unsigned const * base = &globals->profile_count_function_calls->first;
    unsigned n = 0;
    unsigned longest_name_length = 0;
    unsigned u;
    unsigned i = 0;
	
	map = jk_get_profile_count_function_calls_map(&n);

    for ( i = 0 ; i != n ; ++i)
    {
        unsigned name_length = map[i].name.length;
    ...
    for ( i = 0 ; i != n ; ++i)
    {
	    jk_printf("%-*s %u\n", (int)longest_name_length, map[i].name.chars, u = *(base + map[i].index));
    }
}
...
/*
    jk_number_of(jk_profile_count_function_calls_map),
    &jk_profile_count_function_calls_map[0],

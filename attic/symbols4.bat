...
sub ImageOpen
{
    ...
    $image = NewHashRef();
    $section_header = NewArrayRef();
    $section_headers = NewHashRef();
    ...
    for ($i = 0 ; $i != $j ; ++$i)
    {
        (
            ...
            $section_headers[$i]->{'virtual_size'},
            $section_headers[$i]->{'virtual_address'},
            $section_headers[$i]->{'size_of_raw_data'},
            $section_headers[$i]->{'pointer_to_raw_data'},
            $section_headers[$i]->{'pointer_to_relocations'},
            $section_headers[$i]->{'pointer_to_line_numbers'},
            $section_headers[$i]->{'number_of_relocations'},
            $section_headers[$i]->{'number_of_line_numbers'},

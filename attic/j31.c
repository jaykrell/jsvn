...
static const char sourcefile[] = "j31.c";
...
jk_profile_record_t * jk_profile_record_list;

#define jk_profile_count_function_call(function_name) \
	do { \
		static jk_profile_record_t profile_record = { 0, 0, jk_make_profile_function_name_string(#function_name) }; \
    ...
    )
{
    ...
    for ( p = jk_profile_record_list ; p ; p = p->next )
    {
    ...
    )
{
	...
	jk_profile_count_function_call(jk_compact_compactable_heap);

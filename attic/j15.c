    ...
    )
{
    ...
    jk_ulonglong_from_high_low_32bit_ulongs(&nan[1], 0x7ffffffUL, 0xffffffffUL);    
    ...
    jk_ulonglong_from_high_low_32bit_ulongs(&nan[3], 0xfffffffUL, 0xffffffffUL);    
    ...
    result = sign * (ldexp(mantissa_low32, exponent - 1075) + ldexp(mantissa_high20, exponent - 1070));
exit:
    jk_debug_printf("%s %f\n", function, result);

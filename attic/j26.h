...
{	
    size_t size;
    long (*construct_n)(jk_type_t *, void * , size_t n);
    void (*destroy_n)(jk_type_t *, void *, size_t n);
    long (*copy_n)(jk_type_t *, void * , const void *, size_t n);
    long (*move_n)(jk_type_t *, void * , void*, size_t n);
    unsigned is_signed;
    long (*get_dump_length)(jk_type_t *, size_t buffer_size, char * buffer, void * data);
    void (*dump)(jk_type_t *, size_t buffer_size, char * buffer, void * data);
};

size_t jk_type_char_get_size(jk_type_t *);
size_t jk_type_uchar_get_size(jk_type_t *);
size_t jk_type_short_get_size(jk_type_t *);
size_t jk_type_ushort_get_size(jk_type_t *);
size_t jk_type_int_get_size(jk_type_t *);
size_t jk_type_uint_get_size(jk_type_t *);
size_t jk_type_long_get_size(jk_type_t *);
size_t jk_type_ulong_get_size(jk_type_t *);
size_t jk_type_void_pointer_get_size(jk_type_t *);

...
typedef struct jk_code_generater_address_t jk_code_generater_address_t;
typedef struct jk_code_generater_queued_instructions_t jk_code_generater_queued_instructions_t;
typedef struct jk_code_generater_t jk_code_generater_t;
typedef struct jk_code_generater_label_t jk_code_generater_label_t;

struct jk_code_generater_label_t {
	jk_ulonglong_t value;
	jk_string_t name;
	unsigned value_valid : 1;
};
	
struct jk_code_generater_address_t {
/*
load r1,  n1
load r1,  r2
load r1,  r2  + n1
...
load r1, (r2) + (r3)
*/
	jk_string_t informative_name;
	union {
		jk_ulonglong_t constant;
		jk_code_generater_label_t label;
	} n1;
	unsigned r2;
	unsigned r3;
 /* These cannot all be valid. */
 	unsigned valid_r2 : 1;
	unsigned valid_r3 : 1;
	unsigned valid_n1 : 1;
	unsigned valid_n1_constant : 1;
	unsigned valid_n1_label : 1;
	unsigned operands : 2; /* only 1, 2, 3 allowed */
	unsigned indirections : 2 /* only 0, 1, 2, allowed */
 /* maximum 2 indirections */
	unsigned indirect_n1 : 1;
	unsigned indirect_r2 : 1;
	unsigned indirect_r3: 1;
	unsigned indirect_sum : 1;
};
...
typedef struct jk_code_generater_register_delta_t {
	unsigned reg;
	int delta;
} jk_code_generater_register_delta_t;

typedef struct jk_code_generater_processor_independent_condition_register_fields_t {
	unsigned c : 1;
	unsigned n : 1;
	unsigned v : 1;
	unsigned z : 1;
} jk_code_generater_processor_independent_condition_register_fields_t;

unsigned
jk_code_generater_convert_processor_independent_condition_register_fields_to_integer(
	const jk_code_generater_processor_independent_condition_register_fields_t* fields,
	);

void
jk_code_generater_convert_integer_to_processor_independent_condition_register_fields(
	unsigned integer,
	jk_code_generater_processor_independent_condition_register_fields_t* fields
	);
	
struct jk_code_generater_processor_independent_condition_registers_t {
/* x86, 65816, 68k have one, powerpc has four */
	unsigned number_of_condition_registers;
	jk_code_generater_processor_independent_condition_register_t condition_registers[4];
} jk_code_generater_processor_independent_condition_registers_t;

struct jk_code_generater_condition_t {
/* x86, 65816, 68k have one, powerpc has four */
	unsigned index;
	unsigned bitmask;
	unsigned bits_set;
	unsigned bits_clear;
} jk_code_generater_condition_t;

typedef struct jk_code_generater_instruction_t {
	unsigned char bytes[16];
	jk_code_generater_address_t* addresses_read[4];
	jk_code_generater_address_t* addresses_written[4];
	unsigned registers_read[4];
	unsigned registers_written[4];
	jk_code_generater_register_delta_t register_deltas[4];
	unsigned is_unconditional_branch : 1;
	unsigned is_conditional_branch : 1;
	unsigned is_position_independent : 1;
	unsigned condition;
} jk_code_generater_instruction_t;

/*
The goal of this is function is in the face of frame-pointer-omission optimization
to fix up stack pointer relative references after pushes and pops.
*/
void
jk_code_generator_apply_register_delta_to_instruction(
	jk_code_generater_t* cg,
	jk_code_generater_register_delta_t* delta,	
	jk_code_generater_instruction_t* instruction
	);
	
typedef struct jk_code_generater_t {
	unsigned char* byte_stream;
	unsigned byte_stream_position;
	unsigned byte_stream_size;
	unsigned max_in_parameters_in_registers;
	unsigned max_locals_in_registers;
	unsigned max_out_parameters_in_registers;
	unsigned scratch_register_counter;
	unsigned number_of_scratch_registers;
	unsigned registers_in_use_mask;
	unsigned scratch_registers_in_use_mask;
	unsigned default_calling_convention;
	unsigned number_of_parameter_words_in;
	unsigned number_of_parameter_words_out;
	unsigned number_of_locals_words;
	unsigned number_of_returned_words;
	unsigned is_leaf;
	jk_code_generater_address_t locals[32];
	jk_code_generater_address_t in_parameters[32];
	jk_code_generater_address_t out_parameters[32];
	jk_code_generater_instruction_t queued_instructions[32];
	void* processor;
	struct jk_code_generater_t* parent;
} jk_code_generater_t;

unsigned
jk_code_generater_get_scratch_register(
	jk_code_generater_t* cg
	);

void
jk_code_generater_free_scratch_register(
	jk_code_generater_t* cg,
	unsigned reg
	);
...
void
jk_code_generater_generate_x86_pop(
	jk_code_generater_t* cg,
	jk_code_generater_value_t* value
	);

void
jk_code_generater_generate_x86_call(
	jk_code_generater_t* cg,
	jk_code_generater_value_t* value
	);

void
jk_code_generater_generate_x86_push_register(
	jk_code_generater_t* cg,
	unsigned reg
	);

void
jk_code_generater_generate_x86_pop_register(
	jk_code_generater_t* cg,
	unsigned reg
	);
...
void
jk_code_generater_generate_x86_store_register(
	jk_code_generater_t* cg,
	unsigned reg,
	jk_code_generater_value_t* value
	);
...
void
jk_code_generater_generate_x86_stdcall_call(
	jk_code_generater_t* cg,
	jk_code_generater_value_t* target,
	unsigned number_of_parameters,
	jk_code_generater_value_t* parameters
	);

void
jk_code_generater_generate_x86_fastcall_call(
	jk_code_generater_t* cg,
	jk_code_generater_address_t* target,
	unsigned number_of_parameters,
	jk_code_generater_address_t* parameters
	);

void
jk_code_generater_generate_x86_cdecl_call(
	jk_code_generater_t* cg,
	jk_code_generater_address_t* target,
	unsigned number_of_parameters,
	jk_code_generater_address_t* parameters
...
void
jk_code_generater_generate_powerpc_macosx_macho_call(
	);

void
jk_code_generater_generate_powerpc_macos_pef_call(
	);

unsigned
jk_map_x86_register_name_to_register_number(
	jk_string_t*
	);

jk_map_x86_register_number_to_register_name(
	unsigned
	);

jk_string_t*
jk_map_powerpc_register_number_to_registere_name(
	unsigned
	);

#define jk_calling_convention_default  ('d')
#define jk_calling_convention_stdcall  ('s')
#define jk_calling_convention_fastcall ('f')
#define jk_calling_convention_cdecl    ('c')
...
void
jk_generate_code_epilog(
	jk_code_generater_t* cg
	);

void
jk_generate_code_pass_register_as_parameter(
	jk_code_generater_t* cg,
	unsigned reg
	);

void
jk_generate_code_pass_local_as_parameter(
	jk_code_generater_t* cg,
	unsigned local
	);

void
jk_generate_code_push_register(
	jk_code_generater_t* cg,
	unsigned reg
	);

unsigned
jk_generate_code_is_local_in_register(
	jk_code_generater_t* cg,
	unsigned local,
	unsigned reg
	);
...
unsigned
jk_generate_code_get_register_of_local(
	jk_code_generater_t* cg,
	unsigned local
	);

unsigned
jk_generate_code_is_parameter_in_register(
	jk_code_generater_t* cg,
	unsigned parameter,
	unsigned reg
	);
...
unsigned
jk_generate_code_get_register_of_parameter(
	jk_code_generater_t* cg,
	unsigned parameter
	);

void
jk_generate_code_load_local_into_register(
	jk_code_generater_t* cg,
	unsigned local,
	unsigned reg
	);
...
void
jk_generate_code_load_parameter_into_register(
	jk_code_generater_t *cg,
	unsigned parameter,
	unsigned reg
	);

...
void jk_long_add_with_carry_in(long * a, long b, long c, unsigned carry);
void jk_long_add_with_carry_out(long * a, long b, long c, unsigned * carry);
void jk_long_add_with_carry_in_and_out(long * a, long b, long c, unsigned * carry);

void jk_long_add_in_place_with_carry_in(long * a, long b, unsigned carry);
void jk_long_add_in_place_with_carry_out(long * a, long b, unsigned * carry);
void jk_long_add_in_place_with_carry_in_and_out(long * a, long b, unsigned * carry);

/* unsigned long */

void jk_ulong_add_with_carry_in(unsigned long * a, unsigned long b, unsigned long c, unsigned carry);
void jk_ulong_add_with_carry_out(unsigned long * a, unsigned long b, unsigned long c, unsigned * carry);
void jk_ulong_add_with_carry_in_and_out(unsigned long * a, unsigned long b, unsigned long c, unsigned * carry);

void jk_ulong_add_in_place_with_carry_in(unsigned long * a, unsigned long b, unsigned carry);
void jk_ulong_add_in_place_with_carry_out(unsigned long * a, unsigned long b, unsigned * carry);
void jk_ulong_add_in_place_with_carry_in_and_out(unsigned long * a, unsigned long b, unsigned * carry);

void jk_ulong_add_one_with_carry_out(unsigned long * a, unsigned long b, unsigned * carry);
void jk_ulong_add_one_in_place_with_carry_out(unsigned long * a, unsigned * carry);

/* size_t */

void jk_sizet_add_with_carry_in(size_t * a, size_t b, size_t c, unsigned carry);
void jk_sizet_add_with_carry_out(size_t * a, size_t b, size_t c, unsigned * carry);
void jk_sizet_add_with_carry_in_and_out(size_t * a, size_t b, size_t c, unsigned * carry);

void jk_sizet_add_in_place_with_carry_in(size_t * a, size_t b, unsigned carry);
void jk_sizet_add_in_place_with_carry_out(size_t * a, size_t b, unsigned * carry);
void jk_sizet_add_in_place_with_carry_in_and_out(size_t * a, size_t b, unsigned * carry);

void jk_sizet_add_one_with_carry_out(size_t * a, size_t b, unsigned * carry);
void jk_sizet_add_one_in_place_with_carry_out(size_t * a, unsigned * carry);
void jk_sizet_add_one_in_place_with_carry_out(size_t * a, unsigned * carry);
...
typedef jk_ulong_ptr_t jk_spin_lock_t;
typedef jk_ulong_ptr_t jk_irql_t;
...
typedef struct jk_profile_record_t {
	...
	jk_seven_bit_constant_string_t function_name;
} jk_profile_record_t;

    ...
    )
{
    ...
    jk_profile_count_function_calls_map_entry_t const * const map = globals->profile_count_function_calls_map[0];
    jk_profile_count_function_calls_t const * count = globals->profile_count_function_calls;
    const size_t n = jk_number_of(*globals->profile_count_function_calls_map);
...
const jk_globals_t jk_globals = { &jk_fields, &jk_types, &jk_profile_count_function_calls };

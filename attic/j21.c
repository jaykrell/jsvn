...
jk_init_classfile_type_info(void)
{
	...
	jk_java_packed_classfile1_type_info = classfile1_type_info;
	jk_java_packed_classfile2_type_info = classfile2_type_info;
}
    ...
    )
{
	...
	/* This hangs MPW IIGS ORCA/C 1.0.1.
...
#pragma unused(ppcf)
	...
	err = jk_file_open_for_read(0/*globals*/, 0/*file*/, 0/*filepath*/);
    if (err < 0)
        goto exit;
...
{    
	const_jk_globals_t * globals = &jk_globals;

...
typedef struct jk_wide_string_constant_t {
    const WCHAR* chars; /* TBD host vs. target character sets and wide char representation */
    size_t length;
...
typedef struct MacResourceForkHeader
{
	...
	ULONG OffsetToResorceData;
	ULONG OffsetToResourceMap;
	ULONG LengthOfResourceData;
	ULONG LengthOfRresourceMap;
...
typedef struct MacResourceForkHeader_Packed
{
	...
	UCHAR OffsetToResorceData[4];
	UCHAR OffsetToResourceMap[4];
	UCHAR LengthOfResourceData[4];
	UCHAR LengthOfRresourceMap[4];
...
typedef struct MacPEFContainerHeader_Packed
{
	...
	UCHAR Tag2[4];
	UCHAR Architecture[4];
	UCHAR FormatVersion[4];
	UCHAR DateTimeStamp[4];
	UCHAR OldDefVersion[4];
	UCHAR OldImpVersion[4];
	UCHAR CurrentVersion[4];
	UCHAR SectionCount[2];
	UCHAR InstSectionCount[2];
	UCHAR ReservedA[4];
...
typedef struct MacPEFSectionHeader_Packed
{
	...
	UCHAR NameOffset[4];
	UCHAR DefaultAddress[4];
	UCHAR TotalSize[4];
	UCHAR UnpackedSize[4];
	UCHAR PackedSize[4];
	UCHAR ContainerOffset[4];
	UCHAR SectionKind;
	UCHAR ShareKind;
	UCHAR Alignment;
	UCHAR ReservedA;
...
typedef struct MacPEFLoaderInfoHeader
{
	...
	ULONG TermSection;
	ULONG TermOffset;
	ULONG ImportedLibraryCount;
	ULONG TotalmportedSymbolCount;
	ULONG RelocSectionCount;
	ULONG RelocInstrSectionCount;
	ULONG LoaderStringOffset;
	ULONG ExportHashOffset;
	ULONG ExportHashTablePower;
	ULONG ExportedSymbolCount;
...
typedef struct MacPEFLoaderInfoHeader_Packed
{
	...
	UCHAR TermSection[4];
	UCHAR TermOffset[4];
	UCHAR ImportedLibraryCount[4];
	UCHAR TotalmportedSymbolCount[4];
	UCHAR RelocSectionCount[4];
	UCHAR RelocInstrSectionCount[4];
	UCHAR LoaderStringOffset[4];
	UCHAR ExportHashOffset[4];
	UCHAR ExportHashTablePower[4];
	UCHAR ExportedSymbolCount[4];
...
typedef struct MacPEFImportedLibrary
{
	...
	ULONG OldImpVersion;
	ULONG CurrentVersion;
	ULONG ImportedSymbolCount;
	ULONG FirstImportedSymbol;
	UCHAR Options;
	UCHAR ReservedA;
	USHORT ReservedB;
...
typedef struct MacPEFImportedLibrary_Packed
{
	...
	UCHAR OldImpVersion[4];
	UCHAR CurrentVersion[4];
	UCHAR ImportedSymbolCount[4];
	UCHAR FirstImportedSymbol[4];
	UCHAR Options;
	UCHAR ReservedA;
	UCHAR ReservedB[2];
...
struct MacPEFRelocationHeader_Packed
{
	...
	UCHAR SectionIndex[2];
	UCHAR ReservedA[2];
	UCHAR RelocCount[4];
	UCHAR FirstRelocOffset[4];
};

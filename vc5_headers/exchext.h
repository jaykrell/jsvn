...
typedef unsigned (__stdcall  * LPEECFHOOKPROC)(HWND, unsigned, WPARAM, LPARAM);
...
EXCHEXTCHOOSEFOLDER,  * LPEXCHEXTCHOOSEFOLDER;
...
typedef struct _PROPSHEETPAGE  * LPPROPSHEETPAGE;
#endif
...
DECLARE_INTERFACE_(IExchExtModelessCallback, IUnknown)
{
    ...
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, void*  * lppvObj) PURE;
...
DECLARE_INTERFACE_(IExchExtCallback, IUnknown)
{
    ...
    STDMETHOD(GetVersion) (THIS_ unsigned long  * lpulVersion, unsigned long ulFlags) PURE;
    STDMETHOD(GetWindow) (THIS_ HWND  * lphwnd) PURE;
    STDMETHOD(GetMenu) (THIS_ HMENU  * lphmenu) PURE;
    STDMETHOD(GetToolbar) (THIS_ unsigned long tbid, HWND  * lphwndTb) PURE;
    STDMETHOD(GetSession) (THIS_ LPMAPISESSION  * lppses, 
                           LPADRBOOK  * lppab) PURE;
    STDMETHOD(GetObject) (THIS_ LPMDB  * lppmdb, 
                          LPMAPIPROP  * lppmp) PURE;
    STDMETHOD(GetSelectionCount) (THIS_ unsigned long  * lpceid) PURE;
    STDMETHOD(GetSelectionItem) (THIS_ unsigned long ieid, unsigned long  * lpcbEid,
                                 LPENTRYID  * lppeid, unsigned long  * lpulType,
                                 LPTSTR lpszMsgClass, unsigned long cbMsgClass,
                                 unsigned long  * lpulMsgFlags, unsigned long ulFlags) PURE;
    STDMETHOD(GetMenuPos) (THIS_ unsigned long cmdid, HMENU  * lphmenu,
                           unsigned long  * lpmposMin, unsigned long  * lpmposMax,
                           unsigned long ulFlags) PURE;
    STDMETHOD(GetSharedExtsDir) (THIS_ LPTSTR lpszDir, unsigned long cchDir, 
                                 unsigned long ulFlags) PURE;
    STDMETHOD(GetRecipients) (THIS_ LPADRLIST  * lppal) PURE;
    STDMETHOD(SetRecipients) (THIS_ LPADRLIST lpal) PURE;
    STDMETHOD(GetNewMessageSite) (THIS_ unsigned long fComposeInFolder,
                                  LPMAPIFOLDER pfldFocus,
                                  LPPERSISTMESSAGE ppermsg,
                                  LPMESSAGE  * ppmsg,
                                  LPMAPIMESSAGESITE  * ppmms,
                                  LPMAPIVIEWCONTEXT  * ppmvc,
                                  unsigned long ulFlags) PURE;
    STDMETHOD(RegisterModeless) (THIS_ LPEXCHEXTMODELESS peem,
                                 LPEXCHEXTMODELESSCALLBACK  * ppeemcb) PURE;
...
DECLARE_INTERFACE_(IExchExt, IUnknown)
{
    ...
    STDMETHOD(Install) (THIS_ LPEXCHEXTCALLBACK lpeecb, 
                        unsigned long mecontext, unsigned long ulFlags) PURE;
};
typedef IExchExt  * LPEXCHEXT;

// Type of function called by the client to load an extension
typedef LPEXCHEXT (__stdcall * LPFNEXCHEXTENTRY)(VOID);
...
DECLARE_INTERFACE_(IExchExtCommands, IUnknown)
{
    ...
    STDMETHOD(InstallCommands) (THIS_ LPEXCHEXTCALLBACK lpeecb, HWND hwnd, 
                                HMENU hmenu, unsigned  * lpcmdidBase, 
                                LPTBENTRY lptbeArray, unsigned ctbe, 
                                unsigned long ulFlags) PURE;
    STDMETHOD_(VOID,InitMenu) (THIS_ LPEXCHEXTCALLBACK lpeecb) PURE;
    STDMETHOD(DoCommand) (THIS_ LPEXCHEXTCALLBACK lpeecb, unsigned cmdid) PURE;
    STDMETHOD(Help) (THIS_ LPEXCHEXTCALLBACK lpeecb, unsigned cmdid) PURE;
    STDMETHOD(QueryHelpText) (THIS_ unsigned cmdid, unsigned long ulFlags,
                              LPTSTR lpsz, unsigned cch) PURE;
    STDMETHOD(QueryButtonInfo) (THIS_ unsigned long tbid, unsigned itbb, LPTBBUTTON ptbb,
                                LPTSTR lpsz, unsigned cch, unsigned long ulFlags) PURE;
    STDMETHOD(ResetToolbar) (THIS_ unsigned long tbid, unsigned long ulFlags) PURE;
};
...
DECLARE_INTERFACE_(IExchExtAttachedFileEvents, IUnknown)
{
    ...
    STDMETHOD(OnOpenSzFile)(THIS_ LPTSTR lpszFile, unsigned long ulFlags) PURE;
};
...
DECLARE_INTERFACE_(IExchExtPropertySheets, IUnknown)
{
    ...
    STDMETHOD_(unsigned long,GetMaxPageCount) (THIS_ unsigned long ulFlags) PURE;
    STDMETHOD(GetPages) (THIS_ LPEXCHEXTCALLBACK lpeecb, unsigned long ulFlags,
                         LPPROPSHEETPAGE lppsp, unsigned long  * lpcpsp) PURE;
    STDMETHOD_(VOID,FreePages) (THIS_ LPPROPSHEETPAGE lppsp, 
                                unsigned long ulFlags, unsigned long cpsp) PURE;
};
...
DECLARE_INTERFACE_(IExchExtAdvancedCriteria, IUnknown)
{
    ...
    STDMETHOD_(VOID,SetFolders) (THIS_ LPENTRYLIST lpeidl, unsigned long ulFlags) PURE;
    STDMETHOD(QueryRestriction) (THIS_ void* lpvAllocBase, 
                                 LPSRestriction  * lppres,
                                 LPSPropTagArray  * lppPropTags,
                                 LPMAPINAMEID  *  * lpppPropNames,
                                 BOOL * lpfNot, LPTSTR lpszDesc, unsigned long cchDesc, 
                                 unsigned long ulFlags) PURE;

...
WINCOMMCTRLAPI void __stdcall InitCommonControls(void);
...
WINCOMMCTRLAPI BOOL __stdcall InitCommonControlsEx(LPINITCOMMONCONTROLSEX);
...
typedef struct tagNMCUSTOMDRAWINFO
{
    ...
    HDC hdc;
    RECT rc;
    unsigned long dwItemSpec;  // this is control specific, but it's how to specify an item.  valid only with CDDS_ITEM bit set
    UINT  uItemState;
    LPARAM lItemlParam;
...
WINCOMMCTRLAPI HIMAGELIST  __stdcall ImageList_Create(int cx, int cy, UINT flags, int cInitial, int cGrow);
...
WINCOMMCTRLAPI int         __stdcall ImageList_Add(HIMAGELIST himl, HBITMAP hbmImage, HBITMAP hbmMask);
...
WINCOMMCTRLAPI BOOL __stdcall ImageList_Draw(HIMAGELIST himl, int i, HDC hdcDst, int x, int y, UINT fStyle);


#ifdef _WIN32

WINCOMMCTRLAPI BOOL        __stdcall ImageList_Replace(HIMAGELIST himl, int i, HBITMAP hbmImage, HBITMAP hbmMask);
WINCOMMCTRLAPI int         __stdcall ImageList_AddMasked(HIMAGELIST himl, HBITMAP hbmImage, COLORREF crMask);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_DrawEx(HIMAGELIST himl, int i, HDC hdcDst, int x, int y, int dx, int dy, COLORREF rgbBk, COLORREF rgbFg, UINT fStyle);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_DrawIndirect(IMAGELISTDRAWPARAMS* pimldp);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_Remove(HIMAGELIST himl, int i);
WINCOMMCTRLAPI HICON       __stdcall ImageList_GetIcon(HIMAGELIST himl, int i, UINT flags);
WINCOMMCTRLAPI HIMAGELIST  __stdcall ImageList_LoadImageA(HINSTANCE hi, const char* lpbmp, int cx, int cGrow, COLORREF crMask, UINT uType, UINT uFlags);
WINCOMMCTRLAPI HIMAGELIST  __stdcall ImageList_LoadImageW(HINSTANCE hi, const wchar_t* lpbmp, int cx, int cGrow, COLORREF crMask, UINT uType, UINT uFlags);
...
WINCOMMCTRLAPI BOOL        __stdcall ImageList_Copy(HIMAGELIST himlDst, int iDst, HIMAGELIST himlSrc, int iSrc, UINT uFlags);

WINCOMMCTRLAPI BOOL        __stdcall ImageList_BeginDrag(HIMAGELIST himlTrack, int iTrack, int dxHotspot, int dyHotspot);
WINCOMMCTRLAPI void        __stdcall ImageList_EndDrag();
WINCOMMCTRLAPI BOOL        __stdcall ImageList_DragEnter(HWND hwndLock, int x, int y);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_DragLeave(HWND hwndLock);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_DragMove(int x, int y);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_SetDragCursorImage(HIMAGELIST himlDrag, int iDrag, int dxHotspot, int dyHotspot);

WINCOMMCTRLAPI BOOL        __stdcall ImageList_DragShowNolock(BOOL fShow);
WINCOMMCTRLAPI HIMAGELIST  __stdcall ImageList_GetDragImage(POINT * ppt,POINT * pptHotspot);
...
WINCOMMCTRLAPI HIMAGELIST __stdcall ImageList_Read(LPSTREAM pstm);
WINCOMMCTRLAPI BOOL       __stdcall ImageList_Write(HIMAGELIST himl, LPSTREAM pstm);
#endif
...
WINCOMMCTRLAPI BOOL        __stdcall ImageList_GetIconSize(HIMAGELIST himl, int  *cx, int  *cy);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_SetIconSize(HIMAGELIST himl, int cx, int cy);
WINCOMMCTRLAPI BOOL        __stdcall ImageList_GetImageInfo(HIMAGELIST himl, int i, IMAGEINFO * pImageInfo);
WINCOMMCTRLAPI HIMAGELIST  __stdcall ImageList_Merge(HIMAGELIST himl1, int i1, HIMAGELIST himl2, int i2, int dx, int dy);
...
WINCOMMCTRLAPI HWND __stdcall CreateToolbarEx(HWND hwnd, unsigned long ws, UINT wID, int nBitmaps,
                        HINSTANCE hBMInst, UINT wBMID, LPCTBBUTTON lpButtons,
                        int iNumButtons, int dxButton, int dyButton,
                        int dxBitmap, int dyBitmap, UINT uStructSize);

WINCOMMCTRLAPI HBITMAP __stdcall CreateMappedBitmap(HINSTANCE hInstance, int idBitmap,
...
WINCOMMCTRLAPI void __stdcall DrawStatusTextA(HDC hDC, LPRECT lprc, const char* pszText, UINT uFlags);
WINCOMMCTRLAPI void __stdcall DrawStatusTextW(HDC hDC, LPRECT lprc, const wchar_t* pszText, UINT uFlags);

WINCOMMCTRLAPI HWND __stdcall CreateStatusWindowA(long style, const char* lpszText, HWND hwndParent, UINT wID);
WINCOMMCTRLAPI HWND __stdcall CreateStatusWindowW(long style, const wchar_t* lpszText, HWND hwndParent, UINT wID);
...
WINCOMMCTRLAPI void __stdcall MenuHelp(UINT uMsg, WPARAM wParam, LPARAM lParam, HMENU hMainMenu, HINSTANCE hInst, HWND hwndStatus, UINT  *lpwIDs);
WINCOMMCTRLAPI BOOL __stdcall ShowHideMenuCtl(HWND hWnd, UINT uFlags, LPINT lpInfo);
WINCOMMCTRLAPI void __stdcall GetEffectiveClientRect(HWND hWnd, LPRECT lprc, LPINT lpInfo);
...
WINCOMMCTRLAPI BOOL __stdcall MakeDragList(HWND hLB);
WINCOMMCTRLAPI void __stdcall DrawInsert(HWND handParent, HWND hLB, int nItem);
WINCOMMCTRLAPI int __stdcall LBItemFromPt(HWND hLB, POINT pt, BOOL bAutoScroll);
...
WINCOMMCTRLAPI HWND __stdcall CreateUpDownControl(unsigned long dwStyle, int x, int y, int cx, int cy,
...
#define ListView_GetItemSpacing(hwndLV, fSmall) \
        (unsigned long)SNDMSG((hwndLV), LVM_GETITEMSPACING, fSmall, 0L)
...
#define ListView_SetIconSpacing(hwndLV, cx, cy) \
        (unsigned long)SNDMSG((hwndLV), LVM_SETICONSPACING, 0, MAKELONG(cx,cy))


#define LVM_SETEXTENDEDLISTVIEWSTYLE (LVM_FIRST + 54)
#define ListView_SetExtendedListViewStyle(hwndLV, dw)\
        (unsigned long)SNDMSG((hwndLV), LVM_SETEXTENDEDLISTVIEWSTYLE, 0, dw)

#define LVM_GETEXTENDEDLISTVIEWSTYLE (LVM_FIRST + 55)
#define ListView_GetExtendedListViewStyle(hwndLV)\
        (unsigned long)SNDMSG((hwndLV), LVM_GETEXTENDEDLISTVIEWSTYLE, 0, 0)
...
#define ListView_ApproximateViewRect(hwnd, iWidth, iHeight, iCount) \
        (unsigned long)SNDMSG((hwnd), LVM_APPROXIMATEVIEWRECT, iCount, MAKELPARAM(iWidth, iHeight))
...
#define TabCtrl_SetItemSize(hwnd, x, y) \
    (unsigned long)SNDMSG((hwnd), TCM_SETITEMSIZE, 0, MAKELPARAM(x,y))
...
typedef unsigned long MONTHDAYSTATE,  * LPMONTHDAYSTATE;
...
// unsigned long MonthCal_GetMaxSelCount(HWND hmc)
//   returns the maximum number of selectable days allowed
#define MCM_GETMAXSELCOUNT  (MCM_FIRST + 3)
#define MonthCal_GetMaxSelCount(hmc)    (unsigned long)SNDMSG(hmc, MCM_GETMAXSELCOUNT, 0, 0L)
...
// unsigned long MonthCal_GetMonthRange(HWND hmc, unsigned long gmr, LPSYSTEMTIME rgst)
...
#define MonthCal_GetMonthRange(hmc, gmr, rgst)  (unsigned long)SNDMSG(hmc, MCM_GETMONTHRANGE, (WPARAM)(gmr), (LPARAM)(rgst))
...
// unsigned long result...  low word has the day.  high word is bool if this is app set
// or not (FALSE == using locale info)
#define MCM_GETFIRSTDAYOFWEEK (MCM_FIRST + 16)
#define MonthCal_GetFirstDayOfWeek(hmc) \
        (unsigned long)SNDMSG(hmc, MCM_GETFIRSTDAYOFWEEK, 0, 0)

// unsigned long MonthCal_GetRange(HWND hmc, LPSYSTEMTIME rgst)
//   modifies rgst[0] to be the minimum ALLOWABLE systemtime (or 0 if no minimum)
//   modifies rgst[1] to be the maximum ALLOWABLE systemtime (or 0 if no maximum)
//   returns GDTR_MIN|GDTR_MAX if there is a minimum|maximum limit
#define MCM_GETRANGE (MCM_FIRST + 17)
#define MonthCal_GetRange(hmc, rgst) \
        (unsigned long)SNDMSG(hmc, MCM_GETRANGE, 0, (LPARAM)(rgst))

// BOOL MonthCal_SetRange(HWND hmc, unsigned long gdtr, LPSYSTEMTIME rgst)
...
// unsigned long DateTimePick_GetSystemtime(HWND hdp, LPSYSTEMTIME pst)
//   returns GDT_NONE if "none" is selected (DTS_SHOWNONE only)
//   returns GDT_VALID and modifies *pst to be the currently selected value
#define DTM_GETSYSTEMTIME   (DTM_FIRST + 1)
#define DateTime_GetSystemtime(hdp, pst)    (unsigned long)SNDMSG(hdp, DTM_GETSYSTEMTIME, 0, (LPARAM)(pst))

// BOOL DateTime_SetSystemtime(HWND hdp, unsigned long gd, LPSYSTEMTIME pst)
...
// unsigned long DateTime_GetRange(HWND hdp, LPSYSTEMTIME rgst)
//   modifies rgst[0] to be the minimum ALLOWABLE systemtime (or 0 if no minimum)
//   modifies rgst[1] to be the maximum ALLOWABLE systemtime (or 0 if no maximum)
//   returns GDTR_MIN|GDTR_MAX if there is a minimum|maximum limit
#define DTM_GETRANGE (DTM_FIRST + 3)
#define DateTime_GetRange(hdp, rgst)  (unsigned long)SNDMSG(hdp, DTM_GETRANGE, 0, (LPARAM)(rgst))

// BOOL DateTime_SetRange(HWND hdp, unsigned long gdtr, LPSYSTEMTIME rgst)
//   if GDTR_MIN, sets the minimum ALLOWABLE systemtime to rgst[0], otherwise removes minimum
//   if GDTR_MAX, sets the maximum ALLOWABLE systemtime to rgst[1], otherwise removes maximum
//   returns TRUE on success, FALSE on error (such as invalid parameters)
...
{
    NMHDR      nmhdr;
    const char*     pszUserString;  // string user entered
...
typedef struct tagNMDATETIMEWMKEYDOWNA
{
    ...
    const char*     pszFormat; // format substring
...
typedef struct tagNMDATETIMEFORMATA
{
    ...
    const char* pszDisplay;   // string to display
...
typedef struct tagNMDATETIMEFORMATW
{
    ...
    const wchar_t* pszFormat;   // format substring
    SYSTEMTIME st;       // current systemtime
    const wchar_t* pszDisplay;  // string to display

...
typedef struct {
    unsigned long AddressType;                /* E.164 or NSAP-style ATM Endsystem Address */
    unsigned long NumofDigits;                /* number of digits; */
...
typedef struct {
    unsigned long Layer2Protocol;                 /* User information layer 2 protocol           */
    unsigned long Layer2UserSpecifiedProtocol;    /* User specified layer 2 protocol information */
    unsigned long Layer3Protocol;                 /* User information layer 3 protocol           */
    unsigned long Layer3UserSpecifiedProtocol;    /* User specified layer 3 protocol information */
    unsigned long Layer3IPI;                      /* ISO/IEC TR 9577 Initial Protocol Identifier */
...
typedef struct {
    unsigned long HighLayerInfoType;          /* High Layer Information Type      */
    unsigned long HighLayerInfoLength;        /* number of bytes in HighLayerInfo */
...
typedef struct {
    unsigned long ForwardMaxCPCSSDUSize;
    unsigned long BackwardMaxCPCSSDUSize;
    UCHAR Mode;                        /* only available in UNI 3.0 */
    UCHAR SSCSType;
} AAL5_PARAMETERS;

typedef struct {
    unsigned long UserDefined;
} AALUSER_PARAMETERS; 
...
typedef struct {
    unsigned long PeakCellRate_CLP0;
    unsigned long PeakCellRate_CLP01;
    unsigned long SustainableCellRate_CLP0;
    unsigned long SustainableCellRate_CLP01;
    unsigned long MaxBurstSize_CLP0;
    unsigned long MaxBurstSize_CLP01;
    BOOL  Tagging;
} ATM_TD;

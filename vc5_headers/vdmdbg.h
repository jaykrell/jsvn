...
#define VDMCONTEXT_TO_PROGRAM_COUNTER(Context) (void*)((Context)->Eip)

#define VDMCONTEXT_LENGTH  (sizeof(VDMCONTEXT))
#define VDMCONTEXT_ALIGN   (sizeof(unsigned long))
...
typedef struct _SEGMENT_NOTE {
    ...
    unsigned long   Length;                         // Length of image
} SEGMENT_NOTE;
...
typedef struct {
    ...
    unsigned long   dwNextAlt;
} GLOBALENTRY, *LPGLOBALENTRY;

typedef unsigned long (__stdcall* DEBUGEVENTPROC)( LPDEBUG_EVENT, void* );
...
typedef BOOL (WINAPI *PROCESSENUMPROC)( unsigned long dwProcessId, unsigned long dwAttributes, LPARAM lpUserDefined );
typedef BOOL (WINAPI *TASKENUMPROC)( unsigned long dwThreadId, WORD hMod16, WORD hTask16, LPARAM lpUserDefined );
typedef BOOL (WINAPI *TASKENUMPROCEX)( unsigned long dwThreadId, WORD hMod16, WORD hTask16,
                                       PSZ pszModName, PSZ pszFileName, LPARAM lpUserDefined );

#define WOW_SYSTEM  (unsigned long)0x0001

...
// by GINAs over time, the first unsigned long of each profile structure
...
typedef struct _WLX_PROFILE_V2_0 {
    ...
    wchar_t*               pszNetworkDefaultUserProfile;
...
WINAPI
WlxNegotiate(
    unsigned long                   dwWinlogonVersion,
...
WlxActivateUserShell(
    void*                   pWlxContext,
    wchar_t*                   pszDesktopName,
    wchar_t*                   pszMprLogonScript,
    void*                   pEnvironment
    );

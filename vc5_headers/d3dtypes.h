...
typedef HRESULT (__stdcall* LPD3DVALIDATECALLBACK)(void* lpUserArg, unsigned long dwOffset);
typedef HRESULT (__stdcall* LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd, void* lpContext);

typedef unsigned long D3DCOLOR, D3DCOLOR, *LPD3DCOLOR;

typedef unsigned long D3DMATERIALHANDLE, *LPD3DMATERIALHANDLE;
typedef unsigned long D3DTEXTUREHANDLE, *LPD3DTEXTUREHANDLE;
typedef unsigned long D3DMATRIXHANDLE, *LPD3DMATRIXHANDLE;
...
typedef struct _D3DHVERTEX {
    unsigned long           dwFlags;        /* Homogeneous clipping flags */
    union {
        D3DVALUE    hx;
        D3DVALUE    dvHX;
    };
...
typedef struct _D3DVIEWPORT {
    ...
    unsigned long       dwX;
    unsigned long       dwY;            /* Top left */
    unsigned long       dwWidth;
    unsigned long       dwHeight;       /* Dimensions */
...
typedef struct _D3DTRANSFORMDATA {
    unsigned long           dwSize;
    void*          lpIn;           /* Input vertices */
    unsigned long           dwInSize;       /* Stride of input vertices */
    void*          lpOut;          /* Output vertices */
    unsigned long           dwOutSize;      /* Stride of output vertices */
    LPD3DHVERTEX    lpHOut;         /* Output homogeneous vertices */
    unsigned long           dwClip;         /* Clipping hint */
    unsigned long           dwClipIntersection;
    unsigned long           dwClipUnion;    /* Union of all clip flags */
...
typedef struct _D3DLIGHTDATA {
    ...
    unsigned long                dwInSize;      /* Stride of input elements */
    LPD3DTLVERTEX        lpOut;         /* Output colors */
    unsigned long                dwOutSize;     /* Stride of output colors */
 ...
 */
#define D3DSTATE_OVERRIDE(type) ((unsigned long) (type) + D3DSTATE_OVERRIDE_BIAS)
...
typedef enum _D3DRENDERSTATETYPE {
    ...
    D3DRENDERSTATE_PLANEMASK          = 13,   /* unsigned long physical plane mask */
...
typedef struct _D3DPROCESSVERTICES {
    unsigned long        dwFlags;    /* Do we transform or light or just copy? */
    WORD         wStart;     /* Index to first vertex in source */
    WORD         wDest;      /* Index to first vertex in local buffer */
    unsigned long        dwCount;    /* Number of vertices to be processed */
...
typedef struct _D3DBRANCH {
    unsigned long       dwMask;         /* Bitmask against D3D status */
    unsigned long       dwValue;
    BOOL        bNegate;        /* TRUE to negate comparison */
    unsigned long       dwOffset;       /* How  to branch forward (0 for exit)*/
...
typedef struct _D3DSTATUS {
    unsigned long       dwFlags;        /* Do we set extents or status */
    unsigned long       dwStatus;       /* D3D status */
    D3DRECT     drExtent;
...
typedef struct _D3DSTATS {
    unsigned long        dwSize;
    unsigned long        dwTrianglesDrawn;
    unsigned long        dwLinesDrawn;
    unsigned long        dwPointsDrawn;
    unsigned long        dwSpansDrawn;
    unsigned long        dwVerticesProcessed;
} D3DSTATS, *LPD3DSTATS;
...
typedef struct _D3DEXECUTEDATA {
    unsigned long       dwSize;
    unsigned long       dwVertexOffset;
    unsigned long       dwVertexCount;
    unsigned long       dwInstructionOffset;
    unsigned long       dwInstructionLength;
    unsigned long       dwHVertexOffset;

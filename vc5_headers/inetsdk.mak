...
!ifdef nodebug
libs = $(libs) ..\Lib\CtlFwR32.Lib
!else
libs = $(libs) ..\Lib\CtlFwD32.Lib
!endif
...
cDefines= -I..\Include $(cDefines) -FI..\Include\VC41Warn.h
RFLAGS= -I..\Include $(RFLAGS)
...
$(ObjDir)\$(Proj)Ifc.h $(ObjDir)\$(Proj).Tlb: $(Proj).Odl
  $(MkDest)
  mktyplib /DWIN32 -I..\Include /h $(ObjDir)\$(Proj)Ifc.h /tlb $(ObjDir)\$(Proj).tlb $(Proj).Odl

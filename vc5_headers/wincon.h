...
GenerateConsoleCtrlEvent(
    unsigned long dwCtrlEvent,
    unsigned long dwProcessGroupId
    );
...
WINAPI
SetConsoleTitleA(
    const char* lpConsoleTitle
    );
WINBASEAPI
BOOL
WINAPI
SetConsoleTitleW(
    const wchar_t* lpConsoleTitle
    );
#ifdef UNICODE

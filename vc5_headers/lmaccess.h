...
NetUserChangePassword (
    IN  const wchar_t*   domainname OPTIONAL,
    IN  const wchar_t*   username OPTIONAL,
    IN  const wchar_t*   oldpassword,
    IN  const wchar_t*   newpassword
    );
...
typedef struct _USER_INFO_1 {
    ...
    unsigned long    usri1_password_age;
    unsigned long    usri1_priv;
    LPWSTR   usri1_home_dir;
    LPWSTR   usri1_comment;
    unsigned long    usri1_flags;
...
typedef struct _USER_INFO_2 {
    ...
    unsigned long    usri2_password_age;
    unsigned long    usri2_priv;
    LPWSTR   usri2_home_dir;
    LPWSTR   usri2_comment;
    unsigned long    usri2_flags;
    ...
    unsigned long    usri2_last_logon;
    unsigned long    usri2_last_logoff;
    unsigned long    usri2_acct_expires;
    unsigned long    usri2_max_storage;
    unsigned long    usri2_units_per_week;
    PBYTE    usri2_logon_hours;
    unsigned long    usri2_bad_pw_count;
    unsigned long    usri2_num_logons;
    LPWSTR   usri2_logon_server;
    unsigned long    usri2_country_code;
    unsigned long    usri2_code_page;
...
typedef struct _USER_INFO_3 {
    ...
    unsigned long    usri3_auth_flags;
    LPWSTR   usri3_full_name;
    LPWSTR   usri3_usr_comment;
    LPWSTR   usri3_parms;
    LPWSTR   usri3_workstations;
    unsigned long    usri3_last_logon;
    unsigned long    usri3_last_logoff;
    unsigned long    usri3_acct_expires;
    unsigned long    usri3_max_storage;
    unsigned long    usri3_units_per_week;
    PBYTE    usri3_logon_hours;
    unsigned long    usri3_bad_pw_count;
    unsigned long    usri3_num_logons;
    LPWSTR   usri3_logon_server;
    unsigned long    usri3_country_code;
    unsigned long    usri3_code_page;
...
typedef struct _USER_INFO_11 {
    ...
    unsigned long    usri11_priv;
    unsigned long    usri11_auth_flags;
    unsigned long    usri11_password_age;
    LPWSTR   usri11_home_dir;
    LPWSTR   usri11_parms;
    unsigned long    usri11_last_logon;
    unsigned long    usri11_last_logoff;
    unsigned long    usri11_bad_pw_count;
    unsigned long    usri11_num_logons;
    LPWSTR   usri11_logon_server;
    unsigned long    usri11_country_code;
    LPWSTR   usri11_workstations;
    unsigned long    usri11_max_storage;
    unsigned long    usri11_units_per_week;
    PBYTE    usri11_logon_hours;
    unsigned long    usri11_code_page;
...
typedef struct _USER_INFO_20 {
    ...
    unsigned long    usri20_flags;
    unsigned long    usri20_user_id;
...
typedef struct _USER_INFO_22 {
    ...
    unsigned long    usri22_password_age;
    unsigned long    usri22_priv;
    LPWSTR   usri22_home_dir;
    LPWSTR   usri22_comment;
    unsigned long    usri22_flags;
    LPWSTR   usri22_script_path;
    unsigned long    usri22_auth_flags;
    LPWSTR   usri22_full_name;
    LPWSTR   usri22_usr_comment;
    LPWSTR   usri22_parms;
    LPWSTR   usri22_workstations;
    unsigned long    usri22_last_logon;
    unsigned long    usri22_last_logoff;
    unsigned long    usri22_acct_expires;
    unsigned long    usri22_max_storage;
    unsigned long    usri22_units_per_week;
    PBYTE    usri22_logon_hours;
    unsigned long    usri22_bad_pw_count;
    unsigned long    usri22_num_logons;
    LPWSTR   usri22_logon_server;
    unsigned long    usri22_country_code;
    unsigned long    usri22_code_page;
...
typedef struct _USER_INFO_1010 {
     unsigned long   usri1010_auth_flags;
...
typedef struct _GROUP_INFO_2 {
    ...
    unsigned long    grpi2_group_id;
    unsigned long    grpi2_attributes;
...
typedef struct _GROUP_INFO_1005 {
     unsigned long  grpi1005_attributes;
...
typedef struct _GROUP_USERS_INFO_1 {
     LPWSTR  grui1_name;
     unsigned long   grui1_attributes;
...
NetLocalGroupGetMembers (
    IN  const wchar_t*     servername OPTIONAL,
    IN  const wchar_t*     localgroupname,
    IN  unsigned long      level,
    OUT LPBYTE     *bufptr,
    IN  unsigned long      prefmaxlen,
    OUT LPDWORD    entriesread,
...
NetQueryDisplayInformation(
    ...
    IN unsigned long EntriesRequested,
    IN unsigned long PreferredMaximumLength,
    OUT LPDWORD ReturnedEntryCount,
    OUT void*   *SortedBuffer );
...
typedef struct _NET_DISPLAY_USER {
    ...
    unsigned long    usri1_user_id;
    unsigned long    usri1_next_index;
...
typedef struct _NET_DISPLAY_MACHINE {
    ...
    LPWSTR   usri2_comment;
    unsigned long    usri2_flags;
    unsigned long    usri2_user_id;
    unsigned long    usri2_next_index;
} NET_DISPLAY_MACHINE, *PNET_DISPLAY_MACHINE;

typedef struct _NET_DISPLAY_GROUP {
    LPWSTR   grpi3_name;
    LPWSTR   grpi3_comment;
    unsigned long    grpi3_group_id;
    unsigned long    grpi3_attributes;
    unsigned long    grpi3_next_index;
...
NetAccessEnum (
    IN  const wchar_t*     servername OPTIONAL,
    IN  const wchar_t*     BasePath,
    IN  unsigned long      Recursive,
    IN  unsigned long      level,
    OUT LPBYTE     *bufptr,
    IN  unsigned long      prefmaxlen,
    OUT LPDWORD    entriesread,
...
I_NetLogonControl(
    IN const wchar_t* ServerName OPTIONAL,
    IN unsigned long FunctionCode,
    IN unsigned long QueryLevel,
    OUT LPBYTE *Buffer
    );
...
typedef struct _NETLOGON_INFO_3 {
        unsigned long netlog3_flags;
        unsigned long netlog3_logon_attempts;
        unsigned long netlog3_reserved1;
        unsigned long netlog3_reserved2;
        unsigned long netlog3_reserved3;
        unsigned long netlog3_reserved4;
        unsigned long netlog3_reserved5;

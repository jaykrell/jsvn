...
typedef void (*D3DRMDEVICEPALETTECALLBACK)
    (LPDIRECT3DRMDEVICE lpDirect3DRMDev, void* lpArg, unsigned long dwIndex, long red, long green, long blue);
...
DECLARE_INTERFACE_(IDirect3DRM, IUnknown)
{
    ...
    STDMETHOD(CreateObject)
        (THIS_ REFCLSID rclsid, LPUNKNOWN pUnkOuter, REFIID riid, void* * ppv) PURE;
    ...
    STDMETHOD(CreateDevice)     (THIS_ unsigned long, unsigned long, LPDIRECT3DRMDEVICE *) PURE;
    ...
    (   THIS_ LPDIRECT3DRMDEVICE, LPDIRECT3DRMFRAME, unsigned long, unsigned long,
        unsigned long, unsigned long, LPDIRECT3DRMVIEWPORT *
    ) PURE;
    ...
    STDMETHOD(CreateUserVisual) (THIS_ D3DRMUSERVISUALCALLBACK, void* lPArg, LPDIRECT3DRMUSERVISUAL *) PURE;
    ...
    STDMETHOD(SetSearchPath)    (THIS_ const char*) PURE;
    STDMETHOD(AddSearchPath)    (THIS_ const char*) PURE;
    STDMETHOD(GetSearchPath)    (THIS_ unsigned long *size_return, LPSTR path_return);
    //STDMETHOD(GetSearchPath)  (THIS_ int *return_count, char ***return_path) PURE;
    STDMETHOD(SetDefaultTextureColors)(THIS_ unsigned long) PURE;
    STDMETHOD(SetDefaultTextureShades)(THIS_ unsigned long) PURE;
   
    STDMETHOD(GetDevices)       (THIS_ LPDIRECT3DRMDEVICEARRAY *) PURE;
    STDMETHOD(GetNamedObject)   (THIS_ const char *, LPDIRECT3DRMOBJECT *) PURE;
   
    STDMETHOD(EnumerateObjects) (THIS_ D3DRMOBJECTCALLBACK, void*) PURE;
   
    STDMETHOD(Load)             
    (   THIS_ void*, void*, LPIID *, unsigned long, D3DRMLOADOPTIONS,
        D3DRMLOADCALLBACK, void*, D3DRMLOADTEXTURECALLBACK, void*,
        LPDIRECT3DRMFRAME
    ) PURE;

...
#define UInt32x32To64(a, b) ((DWORDLONG)((unsigned long)(a)) * (DWORDLONG)((unsigned long)(b)))
...
#define UInt32x32To64( a, b ) (DWORDLONG)((DWORDLONG)(unsigned long)(a) * (unsigned long)(b))
...
#define MAKELCID(lgid, srtid)  ((unsigned long)((((unsigned long)((unsigned short  )(srtid))) << 16) |  \
                                         ((unsigned long)((unsigned short  )(lgid)))))
#define LANGIDFROMLCID(lcid)   ((unsigned short  )(lcid))
#define SORTIDFROMLCID(lcid)   ((unsigned short  )((((unsigned long)(lcid)) & NLS_VALID_LOCALE_MASK) >> 16))
...
typedef struct _CONTEXT {
    ...
    unsigned long Psr;          /* processor status */
    ...
    unsigned long Fill[4];      /* padding for 16-byte stack frame alignment */
...
typedef struct _CONTEXT {
    ...
    unsigned long IntV0;        /*  $0: return value register, v0 */
    unsigned long IntT0;        /*  $1: temporary registers, t0 - t7 */
    unsigned long IntT1;        /*  $2: */
    unsigned long IntT2;        /*  $3: */
    unsigned long IntT3;        /*  $4: */
    unsigned long IntT4;        /*  $5: */
    unsigned long IntT5;        /*  $6: */
    unsigned long IntT6;        /*  $7: */
    unsigned long IntT7;        /*  $8: */
    unsigned long IntS0;        /*  $9: nonvolatile registers, s0 - s5 */
    unsigned long IntS1;        /* $10: */
    unsigned long IntS2;        /* $11: */
    unsigned long IntS3;        /* $12: */
    unsigned long IntS4;        /* $13: */
    unsigned long IntS5;        /* $14: */
    unsigned long IntFp;        /* $15: frame pointer register, fp/s6 */
    unsigned long IntA0;        /* $16: argument registers, a0 - a5 */
    unsigned long IntA1;        /* $17: */
    unsigned long IntA2;        /* $18: */
    unsigned long IntA3;        /* $19: */
    unsigned long IntA4;        /* $20: */
    unsigned long IntA5;        /* $21: */
    unsigned long IntT8;        /* $22: temporary registers, t8 - t11 */
    unsigned long IntT9;        /* $23: */
    unsigned long IntT10;       /* $24: */
    unsigned long IntT11;       /* $25: */
    unsigned long IntRa;        /* $26: return address register, ra */
    unsigned long IntT12;       /* $27: temporary register, t12 */
    unsigned long IntAt;        /* $28: assembler temp register, at */
    unsigned long IntGp;        /* $29: global pointer register, gp */
    unsigned long IntSp;        /* $30: stack pointer register, sp */
    unsigned long IntZero;      /* $31: zero register, zero */

    unsigned long Fpcr;         /* floating point control register */
    unsigned long SoftFpcr;     /* software extension to FPCR */

    unsigned long Fir;          /* (fault instruction) continuation address */
    ...
    unsigned long HighIntV0;        /*  $0: return value register, v0 */
    unsigned long HighIntT0;        /*  $1: temporary registers, t0 - t7 */
    unsigned long HighIntT1;        /*  $2: */
    unsigned long HighIntT2;        /*  $3: */
    unsigned long HighIntT3;        /*  $4: */
    unsigned long HighIntT4;        /*  $5: */
    unsigned long HighIntT5;        /*  $6: */
    unsigned long HighIntT6;        /*  $7: */
    unsigned long HighIntT7;        /*  $8: */
    unsigned long HighIntS0;        /*  $9: nonvolatile registers, s0 - s5 */
    unsigned long HighIntS1;        /* $10: */
    unsigned long HighIntS2;        /* $11: */
    unsigned long HighIntS3;        /* $12: */
    unsigned long HighIntS4;        /* $13: */
    unsigned long HighIntS5;        /* $14: */
    unsigned long HighIntFp;        /* $15: frame pointer register, fp/s6 */
    unsigned long HighIntA0;        /* $16: argument registers, a0 - a5 */
    unsigned long HighIntA1;        /* $17: */
    unsigned long HighIntA2;        /* $18: */
    unsigned long HighIntA3;        /* $19: */
    unsigned long HighIntA4;        /* $20: */
    unsigned long HighIntA5;        /* $21: */
    unsigned long HighIntT8;        /* $22: temporary registers, t8 - t11 */
    unsigned long HighIntT9;        /* $23: */
    unsigned long HighIntT10;       /* $24: */
    unsigned long HighIntT11;       /* $25: */
    unsigned long HighIntRa;        /* $26: return address register, ra */
    unsigned long HighIntT12;       /* $27: temporary register, t12 */
    unsigned long HighIntAt;        /* $28: assembler temp register, at */
    unsigned long HighIntGp;        /* $29: global pointer register, gp */
    unsigned long HighIntSp;        /* $30: stack pointer register, sp */
    unsigned long HighIntZero;      /* $31: zero register, zero */

    unsigned long HighFpcr;         /* floating point control register */
    unsigned long HighSoftFpcr;     /* software extension to FPCR */
    unsigned long HighFir;          /* processor status */

    double DoNotUseThisField; /* to force quadword structure alignment */
    unsigned long HighFill[2];      /* padding for 16-byte stack frame alignment */
...
_inline void* GetFiberData( void ) { __asm {
                                        mov eax, fs:[0x10]
                                        mov eax,[eax]
                                        }
                                     }
_inline void* GetCurrentFiber( void ) { __asm mov eax, fs:[0x10] }
...
typedef struct _FLOATING_SAVE_AREA {
    ...
    unsigned char    RegisterArea[SIZE_OF_80387_REGISTERS];
...
typedef struct _CONTEXT {
    ...
    unsigned long Gpr0;                         /* General registers 0..31 */
    unsigned long Gpr1;
    unsigned long Gpr2;
    unsigned long Gpr3;
    unsigned long Gpr4;
    ...
    unsigned long Msr;                          /* Machine status register */
    unsigned long Iar;                          /* Instruction address register */
    ...
    unsigned long Fill[3];                      /* Pad out to multiple of 16 bytes */
    ...
    /* included in CONTEXT_FULL. */
    /**/
    unsigned long Dr0;                          /* Breakpoint Register 1 */
    unsigned long Dr1;                          /* Breakpoint Register 2 */
    unsigned long Dr2;                          /* Breakpoint Register 3 */
    unsigned long Dr3;                          /* Breakpoint Register 4 */
    unsigned long Dr4;                          /* Breakpoint Register 5 */
    unsigned long Dr5;                          /* Breakpoint Register 6 */
    unsigned long Dr6;                          /* Debug Status Register */
    unsigned long Dr7;                          /* Debug Control Register */
...
typedef struct _STACK_FRAME_HEADER {    /* GPR 1 points here */
    unsigned long BackChain;                    /* Addr of previous frame */
    unsigned long GlueSaved1;                   /* Used by glue code */
    unsigned long GlueSaved2;
    unsigned long Reserved1;                    /* Reserved */
    unsigned long Spare1;                       /* Used by tracing, profiling, ... */
    unsigned long Spare2;

    unsigned long Parameter0;                   /* First 8 parameter words are */
    unsigned long Parameter1;                   /*   always present */
...
typedef struct _EXCEPTION_RECORD {
    ...
    unsigned long ExceptionInformation[EXCEPTION_MAXIMUM_PARAMETERS];
    } EXCEPTION_RECORD;
...
/*  and treat an access mask as a unsigned long.  For example */
/**/
/*      DesiredAccess = DELETE | READ_CONTROL */
/**/
/*  So we'll declare ACCESS_MASK as unsigned long */
/**/
...
typedef struct _IMAGE_DOS_HEADER {  /* DOS .EXE header */
    unsigned short  e_magic;        /* 0x00 Magic number */
    unsigned short  e_cblp;         /* 0x02 Bytes on last page of file */
    unsigned short  e_cp;           /* 0x04 Pages in file */
    unsigned short  e_crlc;         /* 0x06 Relocations */
    unsigned short  e_cparhdr;      /* 0x08 Size of header in paragraphs */
    unsigned short  e_minalloc;     /* 0x0a Minimum extra paragraphs needed */
    unsigned short  e_maxalloc;     /* 0x0c Maximum extra paragraphs needed */
    unsigned short  e_ss;           /* 0x0e Initial (relative) SS value */
    unsigned short  e_sp;           /* 0x10 Initial SP value */
    unsigned short  e_csum;         /* 0x12 Checksum */
    unsigned short  e_ip;           /* 0x14 Initial IP value */
    unsigned short  e_cs;           /* 0x16 Initial (relative) CS value */
    unsigned short  e_lfarlc;       /* 0x18 File address of relocation table */
    unsigned short  e_ovno;         /* 0x1a Overlay number */
    unsigned short  e_res[4];       /* 0x1c Reserved words */
    unsigned short  e_oemid;        /* 0x24 OEM identifier (for e_oeminfo) */
    unsigned short  e_oeminfo;      /* 0x26 OEM information; e_oemid specific */
    unsigned short  e_res2[10];     /* 0x28 Reserved words */
...
typedef struct ANON_OBJECT_HEADER {
    ...
    unsigned short    Sig2;            /* Must be 0xffff */
    unsigned short    Version;         /* >= 1 (implies the CLSID field is present) */
    unsigned short    Machine;
    unsigned long   TimeDateStamp;
    CLSID   ClassID;         /* Used to invoke CoCreateInstance */
    unsigned long   SizeOfData;      /* Size of data that follows the header */
} ANON_OBJECT_HEADER;
...
typedef union _IMAGE_AUX_SYMBOL {
    struct {
        unsigned long    TagIndex;                      /* struct, union, or enum tag index */
        union {
            struct {
    ...
    struct {
        ...
        unsigned long   CheckSum;                       /* checksum for communal */
...
#define INS_IMM64(Value, Address, Size, InstPos, ValPos)  /* Intel-IA64-Filler */\
    *(PDWORD)Address = (*(PDWORD)Address & ~(((1 << Size) - 1) << InstPos)) | /* Intel-IA64-Filler */\
          ((unsigned long)((((ULONGLONG)Value >> ValPos) & (((ULONGLONG)1 << Size) - 1))) << InstPos)  /* Intel-IA64-Filler */
...
typedef struct _IMAGE_LINENUMBER {
    union {
        unsigned long   SymbolTableIndex;               /* Symbol table index of function name if Linenumber is 0. */
        unsigned long   VirtualAddress;                 /* Virtual address of line number. */
    } Type;
...
typedef struct _ImageArchitectureHeader {
    ...
    int :16;                                    /* MBZ */
    unsigned long FirstEntryRVA;                        /* RVA into .arch section to array of ARCHITECTURE_ENTRY's */
} IMAGE_ARCHITECTURE_HEADER, *PIMAGE_ARCHITECTURE_HEADER;

typedef struct _ImageArchitectureEntry {
    unsigned long FixupInstRVA;                         /* RVA of instruction to fixup */
    unsigned long NewInst;                              /* fixup instruction (see alphaops.h) */
...
typedef struct IMPORT_OBJECT_HEADER {
    ...
    unsigned long   SizeOfData;                 /* particularly useful for incremental links */
...
#define HEAP_MAKE_TAG_FLAGS( b, o ) ((unsigned long)((b) + ((o) << 16)))  
...
#define DBG_CONTINUE                    ((unsigned long   )0x00010002L) 
#define DBG_TERMINATE_THREAD            ((unsigned long   )0x40010003L) 
#define DBG_TERMINATE_PROCESS           ((unsigned long   )0x40010004L) 
#define DBG_CONTROL_C                   ((unsigned long   )0x40010005L) 
#define DBG_CONTROL_BREAK               ((unsigned long   )0x40010008L) 
#define DBG_EXCEPTION_NOT_HANDLED       ((unsigned long   )0x80010001L) 
/**/

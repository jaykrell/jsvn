...
#define DEVICE_TYPE unsigned long
...
//     IN unsigned long PartitionType
//     )
//
// Routine Description:
//
...
typedef struct _GETVERSIONINPARAMS {
        ...
        unsigned long   fCapabilities;          // Bit mask of driver capabilities.
...
typedef struct _DRIVERSTATUS {
        ...
        unsigned long   dwReserved[2];          // Reserved for future expansion.
...
typedef struct _SENDCMDOUTPARAMS {
        unsigned long                   cBufferSize;            // Size of bBuffer in bytes

...
#define __stdcall          __export __stdcall
...
WINOLEAPI_(unsigned long) CoBuildVersion( VOID );

/* init/uninit */

WINOLEAPI  CoInitialize(void* pvReserved);
WINOLEAPI_(void)  CoUninitialize(void);
WINOLEAPI  CoGetMalloc(unsigned long dwMemContext, LPMALLOC * ppMalloc);
WINOLEAPI_(unsigned long) CoGetCurrentProcess(void);
WINOLEAPI  CoRegisterMallocSpy(LPMALLOCSPY pMallocSpy);
WINOLEAPI  CoRevokeMallocSpy(void);
WINOLEAPI  CoCreateStandardMalloc(unsigned long memctx, IMalloc * * ppMalloc);

#if (_WIN32_WINNT >= 0x0400 ) || defined(_WIN32_DCOM) // DCOM
WINOLEAPI  CoInitializeEx(void* pvReserved, unsigned long dwCoInit);
#endif // DCOM

#if DBG == 1
WINOLEAPI_(unsigned long) DebugCoGetRpcFault( void );
WINOLEAPI_(void) DebugCoSetRpcFault( unsigned long );
#endif

/* register/revoke/get class objects */

WINOLEAPI  CoGetClassObject(REFCLSID rclsid, unsigned long dwClsContext, void* pvReserved,
                    REFIID riid, void* * ppv);
WINOLEAPI  CoRegisterClassObject(REFCLSID rclsid, LPUNKNOWN pUnk,
                    unsigned long dwClsContext, unsigned long flags, LPDWORD lpdwRegister);
WINOLEAPI  CoRevokeClassObject(unsigned long dwRegister);
WINOLEAPI  CoResumeClassObjects(void);
WINOLEAPI  CoSuspendClassObjects(void);
WINOLEAPI_(unsigned long) CoAddRefServerProcess(void);
WINOLEAPI_(unsigned long) CoReleaseServerProcess(void);
WINOLEAPI  CoGetPSClsid(REFIID riid, CLSID *pClsid);
WINOLEAPI  CoRegisterPSClsid(REFIID riid, REFCLSID rclsid);

/* marshaling interface pointers */

WINOLEAPI CoGetMarshalSizeMax(unsigned long *pulSize, REFIID riid, LPUNKNOWN pUnk,
...
WINOLEAPI CoMarshalInterface(LPSTREAM pStm, REFIID riid, LPUNKNOWN pUnk,
                    unsigned long dwDestContext, void* pvDestContext, unsigned long mshlflags);
WINOLEAPI CoUnmarshalInterface(LPSTREAM pStm, REFIID riid, void* * ppv);
...
WINOLEAPI CoDisconnectObject(LPUNKNOWN pUnk, unsigned long dwReserved);
...
WINOLEAPI CoQueryProxyBlanket(
    IUnknown                  *pProxy,
    unsigned long                     *pwAuthnSvc,
    unsigned long                     *pAuthzSvc,
    OLECHAR                  **pServerPrincName,
    unsigned long                     *pAuthnLevel,
    unsigned long                     *pImpLevel,
    RPC_AUTH_IDENTITY_HANDLE  *pAuthInfo,
    unsigned long                     *pCapabilites );
...
//#ifdef _MAC
//typedef __stdcall HRESULT (* LPFNGETCLASSOBJECT) (REFCLSID, REFIID, void* *);
//#else
typedef HRESULT (__stdcall * LPFNGETCLASSOBJECT) (REFCLSID, REFIID, void* *);
//#endif

//#ifdef _MAC
//typedef __stdcall HRESULT (* LPFNCANUNLOADNOW)(void);
//#else
...
WINOLEAPI_(void*) CoTaskMemAlloc(unsigned long cb);
WINOLEAPI_(void*) CoTaskMemRealloc(void* pv, unsigned long cb);
WINOLEAPI_(void)   CoTaskMemFree(void* pv);
...
WINOLEAPI StgCreateDocfile(const OLECHAR * pwcsName,
            unsigned long grfMode,
...
WINOLEAPI StgOpenStorage(const OLECHAR * pwcsName,
              IStorage  *pstgPriority,
              unsigned long grfMode,
              SNB snbExclude,
              unsigned long reserved,
              IStorage  *  *ppstgOpen);
WINOLEAPI StgOpenStorageOnILockBytes(ILockBytes  *plkbyt,
                  IStorage  *pstgPriority,
                  unsigned long grfMode,
                  SNB snbExclude,
                  unsigned long reserved,
...
WINOLEAPI StgSetTimes(OLECHAR const * lpszName,
...
WINOLEAPI  BindMoniker(LPMONIKER pmk, unsigned long grfOpt, REFIID iidResult, void* * ppvResult);
WINOLEAPI  CoGetObject(const wchar_t* pszName, BIND_OPTS *pBindOptions, REFIID riid, void **ppv);
WINOLEAPI  MkParseDisplayName(LPBC pbc, LPCOLESTR szUserName,
                unsigned long  * pchEaten, LPMONIKER  * ppmk);
...
WINOLEAPI  CreateBindCtx(unsigned long reserved, LPBC * ppbc);
...
WINOLEAPI  GetRunningObjectTable( unsigned long reserved, LPRUNNINGOBJECTTABLE * pprot);

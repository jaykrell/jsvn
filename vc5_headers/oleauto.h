...
#else
#define WINOLEAUTAPI        EXTERN_C DECLSPEC_IMPORT HRESULT __stdcall
#define WINOLEAUTAPI_(type) EXTERN_C DECLSPEC_IMPORT type __stdcall
#endif
...
WINOLEAUTAPI_(BSTR) SysAllocStringByteLen(const char* psz, UINT len);
#endif
...
WINOLEAUTAPI_(SAFEARRAY *) SafeArrayCreateVector(VARTYPE vt, LONG lLbound, unsigned long cElements);
...
#define VAR_TIMEVALUEONLY   ((unsigned long)0x00000001)    /* return time value */
#define VAR_DATEVALUEONLY   ((unsigned long)0x00000002)    /* return date value */
...
WINOLEAUTAPI VarUI1FromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, BYTE * pbOut);
...
WINOLEAUTAPI VarUI1FromUI4(unsigned long ulIn, BYTE *pbOut);
...
WINOLEAUTAPI VarI2FromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, SHORT * psOut);
...
WINOLEAUTAPI VarI2FromUI4(unsigned long ulIn, SHORT *psOut);
...
WINOLEAUTAPI VarI4FromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, LONG * plOut);
...
WINOLEAUTAPI VarI4FromUI4(unsigned long ulIn, LONG *plOut);
...
WINOLEAUTAPI VarR4FromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, FLOAT *pfltOut);
...
WINOLEAUTAPI VarR4FromUI4(unsigned long ulIn, FLOAT *pfltOut);
...
WINOLEAUTAPI VarR8FromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, DOUBLE *pdblOut);
...
WINOLEAUTAPI VarR8FromUI4(unsigned long ulIn, DOUBLE *pdblOut);
...
WINOLEAUTAPI VarDateFromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, DATE *pdateOut);
...
WINOLEAUTAPI VarDateFromUI4(unsigned long ulIn, DATE *pdateOut);
...
WINOLEAUTAPI VarCyFromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, CY * pcyOut);
...
WINOLEAUTAPI VarCyFromUI4(unsigned long ulIn, CY *pcyOut);
WINOLEAUTAPI VarCyFromDec(DECIMAL *pdecIn, CY *pcyOut);

WINOLEAUTAPI VarBstrFromUI1(BYTE bVal, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromI2(SHORT iVal, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromI4(LONG lIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromR4(FLOAT fltIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromR8(DOUBLE dblIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromCy(CY cyIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromDate(DATE dateIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromDisp(IDispatch * pdispIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromBool(VARIANT_BOOL boolIn, LCID lcid, unsigned long dwFlags, BSTR * pbstrOut);
WINOLEAUTAPI VarBstrFromI1(CHAR cIn, LCID lcid, unsigned long dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI2(USHORT uiIn, LCID lcid, unsigned long dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromUI4(unsigned long ulIn, LCID lcid, unsigned long dwFlags, BSTR *pbstrOut);
WINOLEAUTAPI VarBstrFromDec(DECIMAL *pdecIn, LCID lcid, unsigned long dwFlags, BSTR *pbstrOut);
...
WINOLEAUTAPI VarBoolFromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags, VARIANT_BOOL * pboolOut);
...
WINOLEAUTAPI VarBoolFromUI4(unsigned long ulIn, VARIANT_BOOL *pboolOut);
...
WINOLEAUTAPI VarI1FromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, CHAR *pcOut);
...
WINOLEAUTAPI VarI1FromUI4(unsigned long ulIn, CHAR *pcOut);
...
WINOLEAUTAPI VarUI2FromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, USHORT *puiOut);
...
WINOLEAUTAPI VarUI2FromUI4(unsigned long ulIn, USHORT *puiOut);
WINOLEAUTAPI VarUI2FromDec(DECIMAL *pdecIn, USHORT *puiOut);

WINOLEAUTAPI VarUI4FromUI1(BYTE bIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromI2(SHORT uiIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromI4(LONG lIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromR4(FLOAT fltIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromR8(DOUBLE dblIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromDate(DATE dateIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromCy(CY cyIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromDisp(IDispatch *pdispIn, LCID lcid, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromBool(VARIANT_BOOL boolIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromI1(CHAR cIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromUI2(USHORT uiIn, unsigned long *pulOut);
WINOLEAUTAPI VarUI4FromDec(DECIMAL *pdecIn, unsigned long *pulOut);
...
WINOLEAUTAPI VarDecFromStr(OLECHAR *strIn, LCID lcid, unsigned long dwFlags, DECIMAL *pdecOut);
...
WINOLEAUTAPI VarDecFromUI4(unsigned long ulIn, DECIMAL *pdecOut);
...
WINOLEAUTAPI VarParseNumFromStr(OLECHAR * strIn, LCID lcid, unsigned long dwFlags,
            NUMPARSE * pnumprs, BYTE * rgbDig);

WINOLEAUTAPI VarNumFromParseNum(NUMPARSE * pnumprs, BYTE * rgbDig,
            unsigned long dwVtBits, VARIANT * pvar);
 ...
 */
WINOLEAUTAPI VarDateFromUdate(UDATE *pudateIn, unsigned long dwFlags, DATE *pdateOut);

WINOLEAUTAPI VarUdateFromDate(DATE dateIn, unsigned long dwFlags, UDATE *pudateOut);
 ...
 */
#ifdef _WIN32
WINOLEAUTAPI_(unsigned long) LHashValOfNameSysA(SYSKIND syskind, LCID lcid,
            const char* szName);
#endif

WINOLEAUTAPI_(unsigned long)
 ...
 */
WINOLEAUTAPI DispCallFunc(void * pvInstance, unsigned long oVft, CALLCONV cc,
...
WINOLEAUTAPI RevokeActiveObject(unsigned long dwRegister, void * pvReserved);

...
#else
#define WINOLECTLAPI        EXTERN_C DECLSPEC_IMPORT HRESULT __stdcall
#define WINOLECTLAPI_(type) EXTERN_C DECLSPEC_IMPORT type __stdcall
#endif
...
WINOLECTLAPI OleCreatePropertyFrame(HWND hwndOwner, UINT x, UINT y,
    LPCOLESTR lpszCaption, unsigned long cObjects, LPUNKNOWN * ppUnk, unsigned long cPages,
    LPCLSID pPageClsID, LCID lcid, unsigned long dwReserved, void* pvReserved);

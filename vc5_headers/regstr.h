...
#define REGSTR_VAL_CONFIGFLAGS TEXT("ConfigFlags")// (binary unsigned long)
#define REGSTR_VAL_CSCONFIGFLAGS TEXT("CSConfigFlags")// (binary unsigned long)
...
#define REGSTR_VAL_CMENUMFLAGS TEXT("CMEnumFlags")// (binary unsigned long)
#define REGSTR_VAL_CMDRIVFLAGS TEXT("CMDrivFlags")// (binary unsigned long)
...
//
#define REGSTR_VAL_PCICOPTIONS TEXT("PCICOptions")// Binary unsigned long.  IRQ mask in

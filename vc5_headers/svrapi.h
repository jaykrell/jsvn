...
#if !defined(_SVRAPI_)
#define API_FUNCTION /*DECLSPEC_IMPORT*/ API_RET_TYPE __stdcall
#else
...
API_FUNCTION
  NetAccessAdd ( const char  * pszServer,
                 short            sLevel,
                 char  *       pbBuffer,
                 unsigned short   cbBuffer );

API_FUNCTION
  NetAccessCheck ( char  *           pszReserved,
                   char  *           pszUserName,
                   char  *           pszResource,
...
API_FUNCTION
  NetAccessDel ( const char  * pszServer,
                 char  *       pszResource );

API_FUNCTION
  NetAccessEnum ( const char  *     pszServer,
                  char  *           pszBasePath,
                  short                fsRecursive,
                  short                sLevel,
                  char  *           pbBuffer,
...
API_FUNCTION
  NetAccessGetInfo ( const char  *     pszServer,
                     char  *           pszResource,
                     short                sLevel,
                     char  *           pbBuffer,
                     unsigned short       cbBuffer,
...
API_FUNCTION
  NetAccessSetInfo ( const char  * pszServer,
                     char  *       pszResource,
                     short            sLevel,
                     char  *       pbBuffer,
                     unsigned short   cbBuffer,
...
API_FUNCTION
  NetAccessGetUserPerms ( char  *           pszServer,
                          char  *           pszUgName,
                          char  *           pszResource,
 ...
 */
API_FUNCTION
  NetShareAdd ( const char  * pszServer,
                short            sLevel,
                const char  * pbBuffer,
                unsigned short   cbBuffer );
 ...
 *	ENTRY
 *
 *	char  *  servername;     asciz remote srv name, NULL if local
 *	char  *  netname;        asciz network name of share being deleted
 ...
 */
API_FUNCTION
  NetShareDel ( const char  * pszServer,
 ...
 * char  *          servername;     asciz remote server name or NULL if local
 * short               sLevel;         level of detail requested; 1 or 50
 * char  *          pbBuffer;       buffer to return entries in
 * unsigned short      cbBuffer;       size of buffer on call
 * unsigned short  *pcEntriesRead;  # of entries supplied on return
 * unsigned short  *pcTotalAvail ;  total # of entries available
 *
 ...
 */
API_FUNCTION
  NetShareEnum ( const char  *     pszServer,
                 short                sLevel,
                 char  *           pbBuffer,
                 unsigned short       cbBuffer,
                 unsigned short  * pcEntriesRead,
 ...
 * char  *          servername;     asciz remote server name or NULL if local
 * char  *          netname;        asciz network name of share being queried
 * short               level;          level of info requested (50 for Win95 peer servers)
 * char  *          buf;            for returned entry
 * unsigned short      buflen;         size of buffer
 * unsigned short  *totalavail;     total size needed for buffer
 *
 ...
 */
API_FUNCTION
  NetShareGetInfo ( const char  *     pszServer,
                    const char  *     pszNetName,
                    short                sLevel,
                    char  *           pbBuffer,
                    unsigned short       cbBuffer,
 ...
 ***/
API_FUNCTION
  NetShareSetInfo ( const char  * pszServer,
                    const char  * pszNetName,
                    short            sLevel,
                    const char  * pbBuffer,
                    unsigned short   cbBuffer,
...
struct share_info_50 {
	...
	char  *	shi50_remark;                   /* ANSI comment string */
	char  *	shi50_path;                     /* shared resource */
 ...
 ***/
API_FUNCTION
  NetSessionDel ( const char  * pszServer,
 ...
 ***/
API_FUNCTION
  NetSessionEnum ( const char  *     pszServer,
                   short                sLevel,
                   char  *           pbBuffer,
                   unsigned short       cbBuffer,
                   unsigned short  * pcEntriesRead,
...
API_FUNCTION
  NetSessionGetInfo ( const char  *     pszServer,
                      const char  *     pszClientName,
                      short                sLevel,
                      char  *           pbBuffer,
                      unsigned short       cbBuffer,
...
struct session_info_50 {
	char  * sesi50_cname;            //remote computer name (connection id in Netware)
 ...
 ***/
API_FUNCTION
  NetConnectionEnum ( const char  *     pszServer,
                      const char  *     pszQualifier,   /* upper case */
                      short                sLevel,
                      char  *           pbBuffer,
                      unsigned short       cbBuffer,
                      unsigned short  * pcEntriesRead,
...
struct connection_info_50 {
	...
	char  * coni50_netname;          // share name          
	char  * coni50_username;         // user connected to share
}; /* connection_info_50 */
...
/***	NetFileClose2
 *
 *	int  PASCAL	NetFileClose2( servername, fileid )
 *
 *	ENTRY
 *
 *	servername;     asciz remote srv name, NULL if local
 ...
 ***/
API_FUNCTION
  NetFileClose2 ( const char  * pszServer,
                  unsigned long    ulFileId );

/***	NetFileEnum (Admin Only)
 *
 *	int  PASCAL NetFileEnum( servername,
 *				    level, 
 *				    buf, 
 *				    buflen, 
 *				    entriesread, 
...
API_FUNCTION
  NetFileEnum ( const char  *     pszServer,
...
API_FUNCTION
  NetServerGetInfo ( const char  *     pszServer,
                     short                sLevel,
                     char  *           pbBuffer,
                     unsigned short       cbBuffer,
                     unsigned short  * pcbTotalAvail );
...
API_FUNCTION
  NetSecurityGetInfo ( const char  *     pszServer,
                       short                sLevel,
                       char  *           pbBuffer,
                       unsigned short       cbBuffer,
                       unsigned short  * pcbTotalAvail );
...
struct security_info_1 {
    ...
    char  *      sec1_container;	/* Security server/domain     */
    char  *	    sec1_ab_server;	/* Address book server        */
    char  *	    sec1_ab_dll;	/* Address book provider DLL  */
};	/* security_info_1 */

...
#define PSTF_NO_ENCRYPTION              ((unsigned long)0x80000000)
#define PSTF_COMPRESSABLE_ENCRYPTION    ((unsigned long)0x40000000)
#define PSTF_BEST_ENCRYPTION            ((unsigned long)0x20000000)

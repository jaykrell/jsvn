...
BEGIN_INTERFACE
    ...
    /* IStringList methods */
    STDMETHOD(get_Item)(THIS_ VARIANT i, VARIANT * pVariantReturn) PURE;
    STDMETHOD(get_Count)(THIS_ int * cStrRet) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * * ppEnumReturn) PURE;
};
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Item)(THIS_ VARIANT Var, VARIANT * pVariantReturn) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * * ppEnumReturn) PURE;
};
...
BEGIN_INTERFACE
    ...
    /* IRequest methods */
    STDMETHOD(get_Item)(THIS_ BSTR bstrVar, IDispatch * * ppObjReturn) PURE;
    STDMETHOD(get_QueryString)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
    STDMETHOD(get_Form)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
    STDMETHOD(get_Body)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
    STDMETHOD(get_ServerVariables)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
    STDMETHOD(get_ClientCertificate)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
    STDMETHOD(get_Cookies)(THIS_ IRequestDictionary * * ppDictReturn) PURE;
};
...
BEGIN_INTERFACE
    ...
    /* IReadCookie methods */
    STDMETHOD(get_Item)(THIS_ VARIANT Var, VARIANT * pVariantReturn) PURE;
    STDMETHOD(get_HasKeys)(THIS_ VARIANT_BOOL * pfHasKeys) PURE;
    STDMETHOD(get__NewEnum)(THIS_ IUnknown * * ppEnumReturn) PURE;
};
...
BEGIN_INTERFACE
    ...
    /* IResponse methods */
    STDMETHOD(get_Buffer)(THIS_ VARIANT_BOOL * fIsBuffering) PURE;
    STDMETHOD(put_Buffer)(THIS_ VARIANT_BOOL fIsBuffering) PURE;
    STDMETHOD(get_ContentType)(THIS_ BSTR * pbstrContentTypeRet) PURE;
    STDMETHOD(put_ContentType)(THIS_ BSTR bstrContentType) PURE;
    STDMETHOD(get_Expires)(THIS_ VARIANT * pvarExpiresMinutesRet) PURE;
    STDMETHOD(put_Expires)(THIS_ long lExpiresMinutes) PURE;
    STDMETHOD(get_ExpiresAbsolute)(THIS_ VARIANT * pvarExpiresRet) PURE;
    STDMETHOD(put_ExpiresAbsolute)(THIS_ DATE dtExpires) PURE;
    STDMETHOD(get_Cookies)(THIS_ IRequestDictionary * * ppCookies) PURE;
    STDMETHOD(get_Status)(THIS_ BSTR * pbstrStatusRet) PURE;
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_SessionID)(THIS_ BSTR * pbstrRet) PURE;
    STDMETHOD(get_Value)(THIS_ BSTR bstrValue, VARIANT * pvar) PURE;
    STDMETHOD(put_Value)(THIS_ BSTR bstrValue, VARIANT var) PURE;
    STDMETHOD(putref_Value)(THIS_ BSTR bstrValue, VARIANT var) PURE;
    STDMETHOD(get_Timeout)(THIS_ long * plvar) PURE;
...
BEGIN_INTERFACE
    ...
    /* IServer methods */
    STDMETHOD(get_ScriptTimeout)(THIS_ long * plTimeoutSeconds) PURE;
    STDMETHOD(put_ScriptTimeout)(THIS_ long lTimeoutSeconds) PURE;
    STDMETHOD(CreateObject)(THIS_ BSTR bstrProgID, IDispatch * * ppDispObject) PURE;
    STDMETHOD(HTMLEncode)(THIS_ BSTR bstrIn, BSTR * pbstrEncoded) PURE;
    STDMETHOD(MapPath)(THIS_ BSTR bstrLogicalPath, BSTR * pbstrPhysicalPath) PURE;
    STDMETHOD(URLEncode)(THIS_ BSTR bstrIn, BSTR * pbstrEncoded) PURE;
};
...
BEGIN_INTERFACE
    ...
    STDMETHOD(get_Request)(THIS_ IRequest * * ppRequest) PURE;
    STDMETHOD(get_Response)(THIS_ IResponse * * ppResponse) PURE;
    STDMETHOD(get_Server)(THIS_ IServer * * ppServer) PURE;
    STDMETHOD(get_Session)(THIS_ ISessionObject * * ppSession) PURE;
    STDMETHOD(get_Application)(THIS_ IApplicationObject * * ppApplication) PURE;
};

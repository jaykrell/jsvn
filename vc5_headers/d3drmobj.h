...
#define IUNKNOWN_METHODS(kind) \
    STDMETHOD(QueryInterface)           (THIS_ REFIID riid, void* *ppvObj) kind; \
    STDMETHOD_(unsigned long, AddRef)           (THIS) kind; \
    STDMETHOD_(unsigned long, Release)          (THIS) kind

/*
 * The methods for IDirect3DRMObject
 */
#define IDIRECT3DRMOBJECT_METHODS(kind) \
    STDMETHOD(Clone)                    (THIS_ LPUNKNOWN pUnkOuter, REFIID riid, void* *ppvObj) kind; \
    STDMETHOD(AddDestroyCallback)       (THIS_ D3DRMOBJECTCALLBACK, void* argument) kind; \
    STDMETHOD(DeleteDestroyCallback)    (THIS_ D3DRMOBJECTCALLBACK, void* argument) kind; \
    STDMETHOD(SetAppData)               (THIS_ unsigned long data) kind; \
    STDMETHOD_(unsigned long, GetAppData)       (THIS) kind; \
...
typedef void (*D3DRMOBJECTCALLBACK)(LPDIRECT3DRMOBJECT obj, void* arg);
typedef void (*D3DRMFRAMEMOVECALLBACK)(LPDIRECT3DRMFRAME obj, void* arg, D3DVALUE delta);
typedef void (*D3DRMUPDATECALLBACK)(LPDIRECT3DRMDEVICE obj, void* arg, int, LPD3DRECT);
typedef int (*D3DRMUSERVISUALCALLBACK)(LPDIRECT3DRMUSERVISUAL obj, void* arg,
...
typedef void (*D3DRMLOADCALLBACK)
     (LPDIRECT3DRMOBJECT object, REFIID objectguid, void* arg);



typedef struct _D3DRMPICKDESC
{
    unsigned long       ulFaceIdx;
    long        lGroupIdx;
    D3DVECTOR   vPosition;
...
DECLARE_INTERFACE_(IDirect3DRMDevice, IDirect3DRMObject)
{
     ...
     */
    STDMETHOD(Init)(THIS_ unsigned long width, unsigned long height) PURE;
    ...
    STDMETHOD(AddUpdateCallback)(THIS_ D3DRMUPDATECALLBACK, void* arg) PURE;
    STDMETHOD(DeleteUpdateCallback)(THIS_ D3DRMUPDATECALLBACK, void* arg) PURE;
    STDMETHOD(SetBufferCount)(THIS_ unsigned long) PURE;
    STDMETHOD_(unsigned long, GetBufferCount)(THIS) PURE;

    STDMETHOD(SetDither)(THIS_ BOOL) PURE;
    STDMETHOD(SetShades)(THIS_ unsigned long) PURE;
    ...
    STDMETHOD_(unsigned long, GetShades)(THIS) PURE;
    STDMETHOD_(unsigned long, GetHeight)(THIS) PURE;
    STDMETHOD_(unsigned long, GetWidth)(THIS) PURE;
    STDMETHOD_(unsigned long, GetTrianglesDrawn)(THIS) PURE;
    STDMETHOD_(unsigned long, GetWireframeOptions)(THIS) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMViewport, IDirect3DRMObject)
{
    ...
    STDMETHOD(Configure)(THIS_ long x, long y, unsigned long width, unsigned long height) PURE;
    STDMETHOD(ForceUpdate)(THIS_ unsigned long x1, unsigned long y1, unsigned long x2, unsigned long y2) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMFrame, IDirect3DRMVisual)
{
    ...
    STDMETHOD(Load)(THIS_ void* filename, void* name, D3DRMLOADOPTIONS loadflags, D3DRMLOADTEXTURECALLBACK, void* lpArg)PURE;
...
DECLARE_INTERFACE_(IDirect3DRMMesh, IDirect3DRMVisual)
{
    ...
    STDMETHOD(GetGroup)(THIS_ D3DRMGROUPINDEX id, unsigned *vCount, unsigned *fCount, unsigned *vPerFace, unsigned long *fDataSize, unsigned *fData) PURE;
    STDMETHOD(GetVertices)(THIS_ D3DRMGROUPINDEX id, unsigned long index, unsigned long count, D3DRMVERTEX *returnPtr) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMFace, IDirect3DRMObject)
{
     ...
     */
     ...
     STDMETHOD(AddVertexAndNormalIndexed)(THIS_ unsigned long vertex, unsigned long normal) PURE;
     STDMETHOD(SetColorRGB)(THIS_ D3DVALUE, D3DVALUE, D3DVALUE) PURE;
     STDMETHOD(SetColor)(THIS_ D3DCOLOR) PURE;
     STDMETHOD(SetTexture)(THIS_ LPDIRECT3DRMTEXTURE) PURE;
     STDMETHOD(SetTextureCoordinates)(THIS_ unsigned long vertex, D3DVALUE u, D3DVALUE v) PURE;
     STDMETHOD(SetMaterial)(THIS_ LPDIRECT3DRMMATERIAL) PURE;
     STDMETHOD(SetTextureTopology)(THIS_ BOOL wrap_u, BOOL wrap_v) PURE;

     STDMETHOD(GetVertex)(THIS_ unsigned long index, D3DVECTOR *vertex, D3DVECTOR *normal) PURE;
     STDMETHOD(GetVertices)(THIS_ unsigned long *vertex_count, D3DVECTOR *coords, D3DVECTOR *normals);
     STDMETHOD(GetTextureCoordinates)(THIS_ unsigned long vertex, D3DVALUE *u, D3DVALUE *v) PURE;
     STDMETHOD(GetTextureTopology)(THIS_ BOOL *wrap_u, BOOL *wrap_v) PURE;
     ...
     STDMETHOD_(int, GetVertexIndex)(THIS_ unsigned long which) PURE;
     STDMETHOD_(int, GetTextureCoordinateIndex)(THIS_ unsigned long which) PURE;
     STDMETHOD_(D3DCOLOR, GetColor)(THIS) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMMeshBuilder, IDirect3DRMVisual)
{
    ...
    STDMETHOD(AddFaces)
    (   THIS_ unsigned long vcount, D3DVECTOR *vertices, unsigned long ncount, D3DVECTOR *normals,
        unsigned long *data, LPDIRECT3DRMFACEARRAY*
    ) PURE;
    STDMETHOD(ReserveSpace)(THIS_ unsigned long vertex_Count, unsigned long normal_count, unsigned long face_count) PURE;
    STDMETHOD(SetColorRGB)(THIS_ D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;
    STDMETHOD(SetColor)(THIS_ D3DCOLOR) PURE;
    STDMETHOD(SetTexture)(THIS_ LPDIRECT3DRMTEXTURE) PURE;
    STDMETHOD(SetMaterial)(THIS_ LPDIRECT3DRMMATERIAL) PURE;
    ...
    STDMETHOD(SetVertex)(THIS_ unsigned long index, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    STDMETHOD(SetNormal)(THIS_ unsigned long index, D3DVALUE x, D3DVALUE y, D3DVALUE z) PURE;
    STDMETHOD(SetTextureCoordinates)(THIS_ unsigned long index, D3DVALUE u, D3DVALUE v) PURE;
    STDMETHOD(SetVertexColor)(THIS_ unsigned long index, D3DCOLOR) PURE;
    STDMETHOD(SetVertexColorRGB)(THIS_ unsigned long index, D3DVALUE red, D3DVALUE green, D3DVALUE blue) PURE;

    STDMETHOD(GetFaces)(THIS_ LPDIRECT3DRMFACEARRAY*) PURE;
    STDMETHOD(GetVertices)
    (   THIS_ unsigned long *vcount, D3DVECTOR *vertices, unsigned long *ncount, D3DVECTOR *normals, unsigned long *face_data_size, unsigned long *face_data
    ) PURE;
    STDMETHOD(GetTextureCoordinates)(THIS_ unsigned long index, D3DVALUE *u, D3DVALUE *v) PURE;
    ...
    STDMETHOD_(int, GetVertexCount)(THIS) PURE;
    STDMETHOD_(D3DCOLOR, GetVertexColor)(THIS_ unsigned long index) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMTexture, IDirect3DRMVisual)
{
    ...
    STDMETHOD_(unsigned long, GetShades)(THIS) PURE;
    STDMETHOD_(unsigned long, GetColors)(THIS) PURE;
    STDMETHOD_(unsigned long, GetDecalScale)(THIS) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMAnimationSet, IDirect3DRMObject)
{
    ...
    STDMETHOD(Load)(THIS_ void* filename, void* name, D3DRMLOADOPTIONS loadflags, D3DRMLOADTEXTURECALLBACK, void* lpArg, LPDIRECT3DRMFRAME parent)PURE;
...
DECLARE_INTERFACE_(IDirect3DRMArray, IUnknown)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
...
DECLARE_INTERFACE_(IDirect3DRMDeviceArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMDEVICE *) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMFrameArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMFRAME *) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMViewportArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMVIEWPORT *) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMVisualArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMVISUAL *) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMPickedArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetPick)(THIS_ unsigned long index, LPDIRECT3DRMVISUAL *, LPDIRECT3DRMFRAMEARRAY *, LPD3DRMPICKDESC) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMLightArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMLIGHT *) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DRMFaceArray, IDirect3DRMArray)
{
    ...
    STDMETHOD_(unsigned long, GetSize)(THIS) PURE;
    STDMETHOD(GetElement)(THIS_ unsigned long index, LPDIRECT3DRMFACE *) PURE;
};

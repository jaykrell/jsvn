...
typedef struct _SHARE_INFO_1 {
    LPTSTR  shi1_netname;
    unsigned long   shi1_type;
    LPTSTR  shi1_remark;
} SHARE_INFO_1, *PSHARE_INFO_1, *LPSHARE_INFO_1;

typedef struct _SHARE_INFO_2 {
    LPTSTR  shi2_netname;
    unsigned long   shi2_type;
    LPTSTR  shi2_remark;
    unsigned long   shi2_permissions;
    unsigned long   shi2_max_uses;
    unsigned long   shi2_current_uses;
    LPTSTR  shi2_path;
    LPTSTR  shi2_passwd;
...
typedef struct _SHARE_INFO_502 {
    ...
    unsigned long   shi502_type;
    LPTSTR  shi502_remark;
    unsigned long   shi502_permissions;
    unsigned long   shi502_max_uses;
    unsigned long   shi502_current_uses;
    LPTSTR  shi502_path;
    LPTSTR  shi502_passwd;
    unsigned long   shi502_reserved;
...
#define SHI_USES_UNLIMITED      (unsigned long)-1
...
typedef struct _SESSION_INFO_502 {
    ...
    unsigned long     sesi502_num_opens;
    unsigned long     sesi502_time;
    unsigned long     sesi502_idle_time;
    unsigned long     sesi502_user_flags;
...
typedef struct _CONNECTION_INFO_0 {
    unsigned long   coni0_id;
} CONNECTION_INFO_0, *PCONNECTION_INFO_0, *LPCONNECTION_INFO_0;

typedef struct _CONNECTION_INFO_1 {
    unsigned long   coni1_id;
    unsigned long   coni1_type;
    unsigned long   coni1_num_opens;
    unsigned long   coni1_num_users;
...
typedef struct _FILE_INFO_3 {
    ...
    unsigned long     fi3_permissions;
    unsigned long     fi3_num_locks;
    LPTSTR    fi3_pathname;
    LPTSTR    fi3_username;

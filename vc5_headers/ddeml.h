...
typedef struct tagCONVINFO {
    ...
    unsigned long   hUser;         /* user specified field  */
...
typedef HDDEDATA __stdcall FNCALLBACK(UINT wType, UINT wFmt, HCONV hConv,
        HSZ hsz1, HSZ hsz2, HDDEDATA hData, unsigned long dwData1, unsigned long dwData2);
...
UINT __stdcall DdeInitializeA(LPDWORD pidInst, PFNCALLBACK pfnCallback,
        unsigned long afCmd, unsigned long ulRes);
...
BOOL __stdcall DdeUninitialize(unsigned long idInst);

/*
 * conversation enumeration functions
 */

HCONVLIST __stdcall DdeConnectList(unsigned long idInst, HSZ hszService, HSZ hszTopic,
...
HCONV __stdcall DdeConnect(unsigned long idInst, HSZ hszService, HSZ hszTopic,
        PCONVCONTEXT pCC);
BOOL __stdcall DdeDisconnect(HCONV hConv);
HCONV __stdcall DdeReconnect(HCONV hConv);
UINT __stdcall DdeQueryConvInfo(HCONV hConv, unsigned long idTransaction, PCONVINFO pConvInfo);
BOOL __stdcall DdeSetUserHandle(HCONV hConv, unsigned long id, unsigned long hUser);
BOOL __stdcall DdeAbandonTransaction(unsigned long idInst, HCONV hConv, unsigned long idTransaction);
...
BOOL __stdcall DdePostAdvise(unsigned long idInst, HSZ hszTopic, HSZ hszItem);
BOOL __stdcall DdeEnableCallback(unsigned long idInst, HCONV hConv, UINT wCmd);
...
HDDEDATA __stdcall DdeNameService(unsigned long idInst, HSZ hsz1, HSZ hsz2, UINT afCmd);
...
HDDEDATA __stdcall DdeClientTransaction(LPBYTE pData, unsigned long cbData,
        HCONV hConv, HSZ hszItem, UINT wFmt, UINT wType,
        unsigned long dwTimeout, LPDWORD pdwResult);

/*
 *data transfer functions
 */

HDDEDATA __stdcall DdeCreateDataHandle(unsigned long idInst, LPBYTE pSrc, unsigned long cb,
        unsigned long cbOff, HSZ hszItem, UINT wFmt, UINT afCmd);
HDDEDATA __stdcall DdeAddData(HDDEDATA hData, LPBYTE pSrc, unsigned long cb, unsigned long cbOff);
unsigned long __stdcall DdeGetData(HDDEDATA hData, LPBYTE pDst, unsigned long cbMax, unsigned long cbOff);
...
UINT __stdcall DdeGetLastError(unsigned long idInst);
...
HSZ  __stdcall DdeCreateStringHandleA(unsigned long idInst, const char* psz, int iCodePage);
HSZ  __stdcall DdeCreateStringHandleW(unsigned long idInst, const wchar_t* psz, int iCodePage);
#ifdef UNICODE
#define DdeCreateStringHandle  DdeCreateStringHandleW
#else
#define DdeCreateStringHandle  DdeCreateStringHandleA
#endif // !UNICODE
unsigned long __stdcall DdeQueryStringA(unsigned long idInst, HSZ hsz, LPSTR psz, unsigned long cchMax, int iCodePage);
unsigned long __stdcall DdeQueryStringW(unsigned long idInst, HSZ hsz, LPWSTR psz, unsigned long cchMax, int iCodePage);
#ifdef UNICODE
#define DdeQueryString  DdeQueryStringW
#else
#define DdeQueryString  DdeQueryStringA
#endif // !UNICODE
BOOL __stdcall DdeFreeStringHandle(unsigned long idInst, HSZ hsz);
BOOL __stdcall DdeKeepStringHandle(unsigned long idInst, HSZ hsz);
...
typedef struct tagDDEML_MSG_HOOK_DATA {    // new for NT
    ...
    UINT uiHi;
    unsigned long cbData;   // amount of data in message, if any. May be > than 32 bytes.
    unsigned long Data[8];  // data peeking by DDESPY is limited to 32 bytes.
...
typedef struct tagMONCBSTRUCT {
    ...
    unsigned long  cbData;                  // new for NT for data peeking
    unsigned long  Data[8];                 // new for NT for data peeking

...
enum SF_REQ_TYPE
{
    ...
    //
    //  pData - Pointer to unsigned long that receives the connection ID.
    //
...
typedef struct _HTTP_FILTER_CONTEXT
{
    ...
    BOOL (__stdcall * GetServerVariable) (
    ...
    BOOL (__stdcall * AddResponseHeaders) (
        struct _HTTP_FILTER_CONTEXT * pfc,
        LPSTR                         lpszHeaders,
        unsigned long                         dwReserved
        );

    BOOL (__stdcall * WriteClient)  (
        struct _HTTP_FILTER_CONTEXT * pfc,
        void*                        Buffer,
        LPDWORD                       lpdwBytes,
        unsigned long                         dwReserved
    ...
    BOOL (__stdcall * ServerSupportFunction) (
        struct _HTTP_FILTER_CONTEXT * pfc,
...
typedef struct _HTTP_FILTER_RAW_DATA
{
    ...
    void*         pvInData;
    unsigned long         cbInData;       // Number of valid data bytes
    unsigned long         cbInBuffer;     // Total size of buffer
...
typedef struct _HTTP_FILTER_AUTHENT
{
    ...
    CHAR * pszUser;
    unsigned long  cbUserBuff;

    CHAR * pszPassword;
    unsigned long  cbPasswordBuff;
...
typedef struct _HTTP_FILTER_ACCESS_DENIED
{
    ...
    unsigned long        dwReason;          // Bitfield of SF_DENIED flags
...
typedef struct _HTTP_FILTER_LOG
{
    ...
    unsigned long  dwHttpStatus;
    unsigned long  dwWin32Status;
...
typedef struct _HTTP_FILTER_VERSION
{
    ...
    unsigned long  dwServerFilterVersion;

    //
    //  Fields specified by the client
    //

    unsigned long  dwFilterVersion;

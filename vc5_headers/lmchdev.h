...
typedef struct _CHARDEVQ_INFO_1 {
    LPWSTR  cq1_dev;
    unsigned long   cq1_priority;
    LPWSTR  cq1_devs;
    unsigned long   cq1_numusers;
    unsigned long   cq1_numahead;
} CHARDEVQ_INFO_1, *PCHARDEVQ_INFO_1, *LPCHARDEVQ_INFO_1;

typedef struct _CHARDEVQ_INFO_1002 {
    unsigned long   cq1002_priority;

...
typedef BOOL ( __stdcall * LPDSENUMCALLBACKW)(GUID  *, wchar_t*, wchar_t*, void*);
typedef BOOL ( __stdcall * LPDSENUMCALLBACKA)(GUID  *, char*, char*, void*);

HRESULT __stdcall DirectSoundCreate(GUID  * lpGUID, LPDIRECTSOUND * ppDS, IUnknown  *pUnkOuter );
HRESULT __stdcall DirectSoundEnumerateW(LPDSENUMCALLBACKW lpCallback, void* lpContext );
HRESULT __stdcall DirectSoundEnumerateA(LPDSENUMCALLBACKA lpCallback, void* lpContext );
...
DECLARE_INTERFACE_( IDirectSound, IUnknown )
{
    ...
    STDMETHOD( CreateSoundBuffer)(THIS_ LPDSBUFFERDESC, LPLPDIRECTSOUNDBUFFER, IUnknown  *) PURE;
    ...
    STDMETHOD( GetSpeakerConfig)(THIS_ unsigned long* ) PURE;
    STDMETHOD( SetSpeakerConfig)(THIS_ unsigned long ) PURE;
...
DECLARE_INTERFACE_( IDirectSoundBuffer, IUnknown )
{
    ...
    STDMETHOD(GetCurrentPosition)(THIS_ unsigned long*,unsigned long* ) PURE;
    STDMETHOD(         GetFormat)(THIS_ LPWAVEFORMATEX, unsigned long, unsigned long* ) PURE;
    STDMETHOD(         GetVolume)(THIS_ long* ) PURE;
    STDMETHOD(            GetPan)(THIS_ long* ) PURE;
    STDMETHOD(      GetFrequency)(THIS_ unsigned long* ) PURE;
    STDMETHOD(         GetStatus)(THIS_ unsigned long* ) PURE;
    STDMETHOD(        Initialize)(THIS_ LPDIRECTSOUND, LPDSBUFFERDESC ) PURE;
    STDMETHOD(              Lock)(THIS_ unsigned long,unsigned long,void*,unsigned long*,void*,unsigned long*,unsigned long ) PURE;
    STDMETHOD(              Play)(THIS_ unsigned long,unsigned long,unsigned long ) PURE;
    STDMETHOD(SetCurrentPosition)(THIS_ unsigned long ) PURE;
    STDMETHOD(         SetFormat)(THIS_ LPWAVEFORMATEX ) PURE;
    STDMETHOD(         SetVolume)(THIS_ long ) PURE;
    STDMETHOD(            SetPan)(THIS_ long ) PURE;
    STDMETHOD(      SetFrequency)(THIS_ unsigned long ) PURE;
    STDMETHOD(              Stop)(THIS  ) PURE;
    STDMETHOD(            Unlock)(THIS_ void*,unsigned long,void*,unsigned long ) PURE;

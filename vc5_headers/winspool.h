...
typedef struct _PRINTER_INFO_2A {
    ...
    unsigned long   DefaultPriority;
    unsigned long   StartTime;
    unsigned long   UntilTime;
    unsigned long   Status;
    unsigned long   cJobs;
    unsigned long   AveragePPM;
...
typedef struct _PRINTER_INFO_5A {
    ...
    LPSTR   pPortName;
    unsigned long   Attributes;
    unsigned long   DeviceNotSelectedTimeout;
    unsigned long   TransmissionRetryTimeout;
...
typedef struct _JOB_INFO_2A {
   ...
   unsigned long    Time;           // How many seconds the job has been printing
   unsigned long    PagesPrinted;

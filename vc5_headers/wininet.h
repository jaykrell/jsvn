...
#define INTERNET_KEEP_ALIVE_UNKNOWN     ((unsigned long)-1)
...
typedef struct {
    ...
    //
    // dwResult - the HINTERNET, unsigned long or BOOL return code from an async API
    //
...
typedef struct {
    ...
    //
    // dwSize - size of file downloaded so 
    //
...
InternetTimeFromSystemTime(
    ...
    IN  unsigned long dwRFC,            // RFC format
    OUT LPSTR lpszTime,         // output string buffer
    IN  unsigned long cbTime            // output buffer size
    );
...
InternetTimeToSystemTime(
    IN  const char* lpszTime,         // NULL terminated string
...
WINAPI
InternetCombineUrlA(
    IN const char* lpszBaseUrl,
    IN const char* lpszRelativeUrl,
    OUT LPSTR lpszBuffer,
    IN OUT LPDWORD lpdwBufferLength,
    IN unsigned long dwFlags
    );
...
WINAPI
InternetCombineUrlW(
    IN const wchar_t* lpszBaseUrl,
    IN const wchar_t* lpszRelativeUrl,
    OUT LPWSTR lpszBuffer,
    IN OUT LPDWORD lpdwBufferLength,
    IN unsigned long dwFlags
    );
...
WINAPI
InternetOpenA(
    IN const char* lpszAgent,
    IN unsigned long dwAccessType,
    IN const char* lpszProxy OPTIONAL,
    IN const char* lpszProxyBypass OPTIONAL,
    IN unsigned long dwFlags
    );
INTERNETAPI
HINTERNET
WINAPI
InternetOpenW(
    IN const wchar_t* lpszAgent,
    IN unsigned long dwAccessType,
    IN const wchar_t* lpszProxy OPTIONAL,
    IN const wchar_t* lpszProxyBypass OPTIONAL,
    IN unsigned long dwFlags
    );
#ifdef UNICODE
...
InternetConnectA(
    IN HINTERNET hInternet,
    IN const char* lpszServerName,
    IN INTERNET_PORT nServerPort,
    IN const char* lpszUserName OPTIONAL,
    IN const char* lpszPassword OPTIONAL,
    IN unsigned long dwService,
    IN unsigned long dwFlags,
...
InternetConnectW(
    IN HINTERNET hInternet,
    IN const wchar_t* lpszServerName,
    IN INTERNET_PORT nServerPort,
    IN const wchar_t* lpszUserName OPTIONAL,
    IN const wchar_t* lpszPassword OPTIONAL,
    IN unsigned long dwService,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
...
InternetOpenUrlA(
    IN HINTERNET hInternet,
    IN const char* lpszUrl,
    IN const char* lpszHeaders OPTIONAL,
    IN unsigned long dwHeadersLength,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
INTERNETAPI
...
InternetOpenUrlW(
    IN HINTERNET hInternet,
    IN const wchar_t* lpszUrl,
    IN const wchar_t* lpszHeaders OPTIONAL,
    IN unsigned long dwHeadersLength,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
...
InternetReadFile(
    IN HINTERNET hFile,
    IN void* lpBuffer,
    IN unsigned long dwNumberOfBytesToRead,
...
InternetWriteFile(
    IN HINTERNET hFile,
    IN LPCVOID lpBuffer,
    IN unsigned long dwNumberOfBytesToWrite,
...
InternetSetOptionA(
    ...
    IN unsigned long dwOption,
    IN void* lpBuffer,
    IN unsigned long dwBufferLength
    );
INTERNETAPI
BOOL
WINAPI
...
(__stdcall * INTERNET_STATUS_CALLBACK)(
    IN HINTERNET hInternet,
    IN unsigned long dwContext,
    IN unsigned long dwInternetStatus,
    IN void* lpvStatusInformation OPTIONAL,
    IN unsigned long dwStatusInformationLength
    );
...
FtpFindFirstFileA(
    ...
    IN const char* lpszSearchFile OPTIONAL,
...
FtpFindFirstFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszSearchFile OPTIONAL,
    OUT LPWIN32_FIND_DATA lpFindFileData OPTIONAL,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
...
FtpGetFileA(
    IN HINTERNET hConnect,
    IN const char* lpszRemoteFile,
    IN const char* lpszNewFile,
    IN BOOL fFailIfExists,
    IN unsigned long dwFlagsAndAttributes,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
INTERNETAPI
...
FtpGetFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszRemoteFile,
    IN const wchar_t* lpszNewFile,
    IN BOOL fFailIfExists,
    IN unsigned long dwFlagsAndAttributes,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
...
FtpPutFileA(
    IN HINTERNET hConnect,
    IN const char* lpszLocalFile,
    IN const char* lpszNewRemoteFile,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
INTERNETAPI
...
FtpPutFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszLocalFile,
    IN const wchar_t* lpszNewRemoteFile,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
#ifdef UNICODE
...
FtpRenameFileA(
    IN HINTERNET hConnect,
    IN const char* lpszExisting,
    IN const char* lpszNew
    );
INTERNETAPI
BOOL
WINAPI
FtpRenameFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszExisting,
    IN const wchar_t* lpszNew
    );
#ifdef UNICODE
...
FtpCreateDirectoryW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszDirectory
    );
#ifdef UNICODE
...
typedef struct {
    ...
    unsigned long GopherType;   // GOPHER_TYPE_, if known
...
typedef struct {
    unsigned long CategoryId;   // e.g. GOPHER_CATEGORY_ID_ADMIN
    unsigned long AttributeId;  // e.g. GOPHER_ATTRIBUTE_ID_ADMIN
    union {
...
GopherCreateLocatorA(
    IN const char* lpszHost,
    IN INTERNET_PORT nServerPort,
    IN const char* lpszDisplayString OPTIONAL,
    IN const char* lpszSelectorString OPTIONAL,
    IN unsigned long dwGopherType,
...
GopherCreateLocatorW(
    IN const wchar_t* lpszHost,
    IN INTERNET_PORT nServerPort,
    IN const wchar_t* lpszDisplayString OPTIONAL,
    IN const wchar_t* lpszSelectorString OPTIONAL,
    IN unsigned long dwGopherType,
...
GopherFindFirstFileA(
    IN HINTERNET hConnect,
    IN const char* lpszLocator OPTIONAL,
    IN const char* lpszSearchString OPTIONAL,
...
GopherFindFirstFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszLocator OPTIONAL,
    IN const wchar_t* lpszSearchString OPTIONAL,
...
GopherOpenFileA(
    IN HINTERNET hConnect,
    IN const char* lpszLocator,
    IN const char* lpszView OPTIONAL,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
INTERNETAPI
...
GopherOpenFileW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszLocator,
    IN const wchar_t* lpszView OPTIONAL,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
#ifdef UNICODE
...
typedef
BOOL
(__stdcall * GOPHER_ATTRIBUTE_ENUMERATOR)(
...
GopherGetAttributeA(
    IN HINTERNET hConnect,
    IN const char* lpszLocator,
    IN const char* lpszAttributeName OPTIONAL,
    OUT LPBYTE lpBuffer,
    IN unsigned long dwBufferLength,
...
GopherGetAttributeW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszLocator,
    IN const wchar_t* lpszAttributeName OPTIONAL,
    OUT LPBYTE lpBuffer,
    IN unsigned long dwBufferLength,
    OUT LPDWORD lpdwCharactersReturned,
    IN GOPHER_ATTRIBUTE_ENUMERATOR lpfnEnumerator OPTIONAL,
...
HttpOpenRequestA(
    ...
    IN const char* lpszObjectName,
    IN const char* lpszVersion,
    IN const char* lpszReferrer OPTIONAL,
    IN const char*  * lplpszAcceptTypes OPTIONAL,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
INTERNETAPI
...
HttpOpenRequestW(
    IN HINTERNET hConnect,
    IN const wchar_t* lpszVerb,
    IN const wchar_t* lpszObjectName,
    IN const wchar_t* lpszVersion,
    IN const wchar_t* lpszReferrer OPTIONAL,
    IN const wchar_t*  * lplpszAcceptTypes OPTIONAL,
    IN unsigned long dwFlags,
    IN unsigned long dwContext
    );
#ifdef UNICODE
...
HttpAddRequestHeadersA(
    ...
    IN const char* lpszHeaders,
    IN unsigned long dwHeadersLength,
    IN unsigned long dwModifiers
    );
INTERNETAPI
BOOL
WINAPI
...
HttpSendRequestA(
    ...
    IN const char* lpszHeaders OPTIONAL,
    IN unsigned long dwHeadersLength,
    IN void* lpOptional OPTIONAL,
    IN unsigned long dwOptionalLength
    );
INTERNETAPI
BOOL
WINAPI
...
HttpQueryInfoA(
    IN HINTERNET hRequest,
    IN unsigned long dwInfoLevel,
    IN OUT void* lpBuffer OPTIONAL,
    IN OUT LPDWORD lpdwBufferLength,
...
InternetSetCookieA(
    IN const char* lpszUrl,
    IN const char* lpszCookieName,
    IN const char* lpszCookieData
    );
INTERNETAPI
BOOL
WINAPI
InternetSetCookieW(
    IN const char* lpszUrl,
    IN const wchar_t* lpszCookieName,
    IN const wchar_t* lpszCookieData
    );
#ifdef UNICODE
...
typedef struct _INTERNET_CACHE_ENTRY_INFOA {
    unsigned long dwStructSize;         // version of cache system. 
    ...
    unsigned long CacheEntryType;       // cache type bit mask.
    unsigned long dwUseCount;           // current users count of the cache entry.
    unsigned long dwHitRate;            // num of times the cache entry was retrieved.
    unsigned long dwSizeLow;            // low unsigned long of the file size.
    unsigned long dwSizeHigh;           // high unsigned long of the file size.
    ...
    unsigned long dwHeaderInfoSize;     // size of the above header.
...
CreateUrlCacheEntryA(
    IN const char* lpszUrlName,
    IN unsigned long dwExpectedFileSize,
    IN const char* lpszFileExtension,
...
CommitUrlCacheEntryA(
    IN const char* lpszUrlName,
    IN const char* lpszLocalFileName,
    IN FILETIME ExpireTime,
    IN FILETIME LastModifiedTime,
    IN unsigned long CacheEntryType,
    IN LPBYTE lpHeaderInfo,
    IN unsigned long dwHeaderSize,
    IN const char* lpszFileExtension,
    IN unsigned long dwReserved
    );
URLCACHEAPI
...
CommitUrlCacheEntryW(
    IN const char* lpszUrlName,
    IN const wchar_t* lpszLocalFileName,
    IN FILETIME ExpireTime,
    IN FILETIME LastModifiedTime,
    IN unsigned long CacheEntryType,
    IN LPBYTE lpHeaderInfo,
    IN unsigned long dwHeaderSize,
    IN const wchar_t* lpszFileExtension,
    IN unsigned long dwReserved
    );
#ifdef UNICODE
...
SetUrlCacheEntryInfoA(
    ...
    IN unsigned long dwFieldControl
    );
URLCACHEAPI
BOOL
WINAPI
...
FindFirstUrlCacheEntryA(
    IN const char* lpszUrlSearchPattern,

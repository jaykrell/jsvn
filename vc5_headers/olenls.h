...
NLSAPI_(int)
CompareStringA(LCID, unsigned long, const char *, int, const char *, int);

NLSAPI_(int)
LCMapStringA(LCID, unsigned long, const char *, int, char *, int);

NLSAPI_(int)
GetLocaleInfoA(LCID, LCTYPE, char *, int);

NLSAPI_(int)
GetStringTypeA(LCID, unsigned long, const char *, int, unsigned short *);

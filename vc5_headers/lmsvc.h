...
typedef struct _SERVICE_INFO_1 {
    LPWSTR  svci1_name;
    unsigned long   svci1_status;
    unsigned long   svci1_code;
    unsigned long   svci1_pid;
} SERVICE_INFO_1, *PSERVICE_INFO_1, * LPSERVICE_INFO_1;

typedef struct _SERVICE_INFO_2 {
    LPWSTR  svci2_name;
    unsigned long   svci2_status;
    unsigned long   svci2_code;
    unsigned long   svci2_pid;
    LPWSTR  svci2_text;
    unsigned long   svci2_specific_error;

...
DECLARE_INTERFACE_(IDirect3D, IUnknown)
{
    ...
    STDMETHOD(EnumDevices)(THIS_ LPD3DENUMDEVICESCALLBACK, void*) PURE;
...
DECLARE_INTERFACE_(IDirect3DDevice, IUnknown)
{
    ...
    STDMETHOD(Execute) (THIS_ LPDIRECT3DEXECUTEBUFFER, LPDIRECT3DVIEWPORT, unsigned long) PURE;
    STDMETHOD(AddViewport) (THIS_ LPDIRECT3DVIEWPORT) PURE;
    STDMETHOD(DeleteViewport) (THIS_ LPDIRECT3DVIEWPORT) PURE;
    STDMETHOD(NextViewport) (THIS_ LPDIRECT3DVIEWPORT, LPDIRECT3DVIEWPORT*, unsigned long) PURE;
    STDMETHOD(Pick) (THIS_ LPDIRECT3DEXECUTEBUFFER, LPDIRECT3DVIEWPORT, unsigned long, LPD3DRECT) PURE;
    STDMETHOD(GetPickRecords)(THIS_ LPDWORD, LPD3DPICKRECORD) PURE;
    STDMETHOD(EnumTextureFormats) (THIS_ LPD3DENUMTEXTUREFORMATSCALLBACK, void*) PURE;
...
DECLARE_INTERFACE_(IDirect3DExecuteBuffer, IUnknown)
{
    ...
    STDMETHOD(Validate) (THIS_ LPDWORD, LPD3DVALIDATECALLBACK, void*, unsigned long) PURE;
    STDMETHOD(Optimize) (THIS_ unsigned long) PURE;
};
...
DECLARE_INTERFACE_(IDirect3DTexture, IUnknown)
{
    ...
    STDMETHOD(PaletteChanged) (THIS_ unsigned long, unsigned long) PURE;
...
DECLARE_INTERFACE_(IDirect3DViewport, IUnknown)
{
    ...
    STDMETHOD(TransformVertices) (THIS_ unsigned long, LPD3DTRANSFORMDATA, unsigned long, LPDWORD) PURE;
    STDMETHOD(LightElements) (THIS_ unsigned long, LPD3DLIGHTDATA) PURE;
    ...
    STDMETHOD(Clear) (THIS_ unsigned long, LPD3DRECT, unsigned long) PURE;
    STDMETHOD(AddLight) (THIS_ LPDIRECT3DLIGHT) PURE;
    STDMETHOD(DeleteLight) (THIS_ LPDIRECT3DLIGHT) PURE;
    STDMETHOD(NextLight) (THIS_ LPDIRECT3DLIGHT, LPDIRECT3DLIGHT*, unsigned long) PURE;
};

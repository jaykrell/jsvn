...
DECLARE_INTERFACE_(_DAODBEngine, _DAO)
	...
	STDMETHOD(get_Workspaces)					 (THIS_ DAOWorkspaces * * ppworks) PURE;
	STDMETHOD(get_Errors)						 (THIS_ DAOErrors * * pperrs) PURE;
	...
	STDMETHOD(_30_CreateWorkspace)				 (THIS_ BSTR Name, BSTR UserName, BSTR Password, DAOWorkspace * * ppwrk) PURE;
	STDMETHOD(OpenDatabase)						 (THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly, VARIANT Connect, DAODatabase * * ppdb) PURE;
	STDMETHOD(CreateDatabase)					 (THIS_ BSTR Name, BSTR Locale, VARIANT Option, DAODatabase * * ppdb) PURE;
	...
	STDMETHOD(ISAMStats)						 (THIS_ long StatNum, VARIANT Reset, long * pl) PURE;
	STDMETHOD(get_SystemDB)						 (THIS_ BSTR * pbstr) PURE;
	STDMETHOD(put_SystemDB)						 (THIS_ BSTR SystemDBPath) PURE;
	STDMETHOD(CreateWorkspace)					 (THIS_ BSTR Name, BSTR UserName, BSTR Password, VARIANT UseType, DAOWorkspace * * ppwrk) PURE;
	STDMETHOD(OpenConnection)					 (THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly, VARIANT Connect, DAOConnection * * ppconn) PURE;
	STDMETHOD(get_DefaultType)					 (THIS_ long * Option) PURE;
...
DECLARE_INTERFACE_(DAOError, IDispatch)
	{
	STDMETHOD(get_Number)						 (THIS_ long * pl) PURE;
	...
	STDMETHOD(get_HelpContext)					 (THIS_ long * pl) PURE;
	};
...
DECLARE_INTERFACE_(DAOErrors, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOError * * pperr) PURE;
	};
...
DECLARE_INTERFACE_(DAOWorkspace, _DAO)
	...
	STDMETHOD(get_Databases)					 (THIS_ DAODatabases * * ppdbs) PURE;
	STDMETHOD(get_Users)						 (THIS_ DAOUsers * * ppusrs) PURE;
	STDMETHOD(get_Groups)						 (THIS_ DAOGroups * * ppgrps) PURE;
	STDMETHOD(BeginTrans)						 (THIS) PURE;
	STDMETHOD(CommitTrans)						 (THIS_ long Options) PURE;
	STDMETHOD(Close)							 (THIS) PURE;
	STDMETHOD(Rollback)							 (THIS) PURE;
	STDMETHOD(OpenDatabase)						 (THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly, VARIANT Connect, DAODatabase * * ppdb) PURE;
	STDMETHOD(CreateDatabase)					 (THIS_ BSTR Name, BSTR Connect, VARIANT Option, DAODatabase * * ppdb) PURE;
	STDMETHOD(CreateUser)						 (THIS_ VARIANT Name, VARIANT PID, VARIANT Password, DAOUser * * ppusr) PURE;
	STDMETHOD(CreateGroup)						 (THIS_ VARIANT Name, VARIANT PID, DAOGroup * * ppgrp) PURE;
	STDMETHOD(OpenConnection)					 (THIS_ BSTR Name, VARIANT Options, VARIANT ReadOnly, VARIANT Connect, DAOConnection * * ppconn) PURE;
	STDMETHOD(get_LoginTimeout)					 (THIS_ long * pTimeout) PURE;
	STDMETHOD(put_LoginTimeout)					 (THIS_ long Timeout) PURE;
	STDMETHOD(get_DefaultCursorDriver)			 (THIS_ long * pCursorType) PURE;
	...
	STDMETHOD(get_Connections)					 (THIS_ DAOConnections * * ppcns) PURE;
	};
...
DECLARE_INTERFACE_(DAOWorkspaces, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOWorkspace * * ppwrk) PURE;
	};
...
DECLARE_INTERFACE_(_DAOTableDef, _DAO)
	{
	STDMETHOD(get_Attributes)					 (THIS_ long * pl) PURE;
	...
	STDMETHOD(get_RecordCount)					 (THIS_ long * pl) PURE;
	STDMETHOD(get_Fields)						 (THIS_ DAOFields * * ppflds) PURE;
	STDMETHOD(get_Indexes)						 (THIS_ DAOIndexes * * ppidxs) PURE;
	...
	STDMETHOD(CreateIndex)						 (THIS_ VARIANT Name, DAOIndex * * ppidx) PURE;
...
DECLARE_INTERFACE_(DAOTableDefs, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOTableDef * * pptdf) PURE;
	};
...
DECLARE_INTERFACE_(DAODatabase, _DAO)
	...
	STDMETHOD(get_Updatable)					 (THIS_ VARIANT_BOOL * pb) PURE;
	STDMETHOD(get_Version)						 (THIS_ BSTR * pbstr) PURE;
	STDMETHOD(get_RecordsAffected)				 (THIS_ long * pl) PURE;
	STDMETHOD(get_TableDefs)					 (THIS_ DAOTableDefs * * pptdfs) PURE;
	STDMETHOD(get_QueryDefs)					 (THIS_ DAOQueryDefs * * ppqdfs) PURE;
	STDMETHOD(get_Relations)					 (THIS_ DAORelations * * pprls) PURE;
	STDMETHOD(get_Containers)					 (THIS_ DAOContainers * * ppctns) PURE;
	STDMETHOD(get_Recordsets)					 (THIS_ DAORecordsets * * pprsts) PURE;
	STDMETHOD(Close)							 (THIS) PURE;
	STDMETHOD(Execute)							 (THIS_ BSTR Query, VARIANT Options) PURE;
	STDMETHOD(_30_OpenRecordset)				 (THIS_ BSTR Name, VARIANT Type, VARIANT Options, DAORecordset * * pprst) PURE;
	STDMETHOD(CreateProperty)					 (THIS_ VARIANT Name, VARIANT Type, VARIANT Value, VARIANT DDL, DAOProperty * * pprp) PURE;
	STDMETHOD(CreateRelation)					 (THIS_ VARIANT Name, VARIANT Table, VARIANT ForeignTable, VARIANT Attributes, DAORelation * * pprel) PURE;
	STDMETHOD(CreateTableDef)					 (THIS_ VARIANT Name, VARIANT Attributes, VARIANT SourceTablename, VARIANT Connect, DAOTableDef * * pptdf) PURE;
	STDMETHOD(BeginTrans)						 (THIS) PURE;
	STDMETHOD(CommitTrans)						 (THIS_ long Options) PURE;
	STDMETHOD(Rollback)							 (THIS) PURE;
	STDMETHOD(CreateDynaset)					 (THIS_ BSTR Name, VARIANT Options, VARIANT Inconsistent, DAORecordset * * pprst) PURE;
	STDMETHOD(CreateQueryDef)					 (THIS_ VARIANT Name, VARIANT SQLText, DAOQueryDef * * ppqdf) PURE;
	STDMETHOD(CreateSnapshot)					 (THIS_ BSTR Source, VARIANT Options, DAORecordset * * pprst) PURE;
	STDMETHOD(DeleteQueryDef)					 (THIS_ BSTR Name) PURE;
	STDMETHOD(ExecuteSQL)						 (THIS_ BSTR SQL, long * pl) PURE;
	STDMETHOD(ListFields)						 (THIS_ BSTR Name, DAORecordset * * pprst) PURE;
	STDMETHOD(ListTables)						 (THIS_ DAORecordset * * pprst) PURE;
	STDMETHOD(OpenQueryDef)						 (THIS_ BSTR Name, DAOQueryDef * * ppqdf) PURE;
	STDMETHOD(OpenTable)						 (THIS_ BSTR Name, VARIANT Options, DAORecordset * * pprst) PURE;
	...
	STDMETHOD(OpenRecordset)					 (THIS_ BSTR Name, VARIANT Type, VARIANT Options, VARIANT LockEdit, DAORecordset * * pprst) PURE;
...
DECLARE_INTERFACE_(DAODatabases, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAODatabase * * ppdb) PURE;
	};
...
DECLARE_INTERFACE_(_DAOQueryDef, _DAO)
	...
	STDMETHOD(get_RecordsAffected)				 (THIS_ long * pl) PURE;
	STDMETHOD(get_Fields)						 (THIS_ DAOFields * * ppflds) PURE;
	STDMETHOD(get_Parameters)					 (THIS_ DAOParameters * * ppprms) PURE;
	STDMETHOD(Close)							 (THIS) PURE;
	STDMETHOD(_30_OpenRecordset)				 (THIS_ VARIANT Type, VARIANT Options, DAORecordset * * pprst) PURE;
	STDMETHOD(_30__OpenRecordset)				 (THIS_ VARIANT Type, VARIANT Options, DAORecordset * * pprst) PURE;
	...
	STDMETHOD(ListParameters)					 (THIS_ DAORecordset * * pprst) PURE;
	STDMETHOD(CreateProperty)					 (THIS_ VARIANT Name, VARIANT Type, VARIANT Value, VARIANT DDL, DAOProperty * * pprp) PURE;
	STDMETHOD(OpenRecordset)					 (THIS_ VARIANT Type, VARIANT Options, VARIANT LockEdit, DAORecordset * * pprst) PURE;
	STDMETHOD(_OpenRecordset)					 (THIS_ VARIANT Type, VARIANT Options, VARIANT LockEdit, DAORecordset * * pprst) PURE;
	...
	STDMETHOD(get_CacheSize)					 (THIS_ long * lCacheSize) PURE;
...
DECLARE_INTERFACE_(DAOQueryDefs, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOQueryDef * * ppqdef) PURE;
	};
...
DECLARE_INTERFACE_(DAORecordset, _DAO)
	...
	STDMETHOD(get_CacheSize)					 (THIS_ long * pl) PURE;
	...
	STDMETHOD(get_AbsolutePosition)				 (THIS_ long * pl) PURE;
	STDMETHOD(put_AbsolutePosition)				 (THIS_ long Position) PURE;
	STDMETHOD(get_EditMode)						 (THIS_ short * pi) PURE;
	STDMETHOD(get_ODBCFetchCount)				 (THIS_ long * pl) PURE;
	STDMETHOD(get_ODBCFetchDelay)				 (THIS_ long * pl) PURE;
	...
	STDMETHOD(get_UpdateOptions)				 (THIS_ long * pl) PURE;
...
DECLARE_INTERFACE_(DAORecordsets, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAORecordset * * pprst) PURE;
	};
...
DECLARE_INTERFACE_(_DAOField, _DAO)
	...
	STDMETHOD(get_Name)							 (THIS_ BSTR * pbstr) PURE;
	STDMETHOD(put_Name)							 (THIS_ BSTR Name) PURE;
	STDMETHOD(get_Size)							 (THIS_ long * pl) PURE;
	...
	STDMETHOD(GetChunk)							 (THIS_ long Offset, long Bytes, VARIANT * pvar) PURE;
	STDMETHOD(_30_FieldSize)					 (THIS_ long * pl) PURE;
	STDMETHOD(CreateProperty)					 (THIS_ VARIANT Name, VARIANT Type, VARIANT Value, VARIANT DDL, DAOProperty * * pprp) PURE;
	...
	STDMETHOD(get_FieldSize)					 (THIS_ long * pl) PURE;
	};
...
DECLARE_INTERFACE_(DAOFields, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOField * * ppfld) PURE;
	};
...
DECLARE_INTERFACE_(_DAOIndex, _DAO)
	...
	STDMETHOD(get_DistinctCount)				 (THIS_ long * pl) PURE;
...
DECLARE_INTERFACE_(DAOIndexes, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOIndex * * ppidx) PURE;
	};
...
DECLARE_INTERFACE_(DAOIndexFields, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, VARIANT * pvar) PURE;
	};
...
DECLARE_INTERFACE_(DAOParameters, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOParameter * * ppprm) PURE;
	};
...
DECLARE_INTERFACE_(DAOUsers, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOUser * * ppusr) PURE;
	};
...
DECLARE_INTERFACE_(DAOGroups, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOGroup * * ppgrp) PURE;
	};
...
DECLARE_INTERFACE_(DAORelations, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAORelation * * pprel) PURE;
	};
...
DECLARE_INTERFACE_(DAOProperties, _DAODynaCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOProperty * * ppprop) PURE;
	};
...
DECLARE_INTERFACE_(DAOContainer, _DAO)
	...
	STDMETHOD(get_Permissions)					 (THIS_ long * pl) PURE;
	...
	STDMETHOD(get_Documents)					 (THIS_ DAODocuments * * ppdocs) PURE;
	STDMETHOD(get_AllPermissions)				 (THIS_ long * pl) PURE;
	};
...
DECLARE_INTERFACE_(DAOContainers, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOContainer * * ppctn) PURE;
	};
...
DECLARE_INTERFACE_(DAODocuments, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAODocument * * ppdoc) PURE;
	};
...
DECLARE_INTERFACE_(DAOConnection, IDispatch)
	...
	STDMETHOD(get_Name)							 (THIS_ BSTR * pbstr) PURE;
	STDMETHOD(get_Connect)						 (THIS_ BSTR * pbstr) PURE;
	STDMETHOD(get_Database)						 (THIS_ DAODatabase * * ppDb) PURE;
...
DECLARE_INTERFACE_(DAOConnections, _DAOCollection)
	{
	STDMETHOD(get_Item)							 (THIS_ VARIANT index, DAOConnection * * ppconn) PURE;
	};

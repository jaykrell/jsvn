...
//
#define PDH_CSTATUS_VALID_DATA           ((unsigned long)0x00000000L)
...
//
#define PDH_CSTATUS_NEW_DATA             ((unsigned long)0x00000001L)
...
//
#define PDH_CSTATUS_NO_MACHINE           ((unsigned long)0x800007D0L)
...
//
#define PDH_CSTATUS_NO_INSTANCE          ((unsigned long)0x800007D1L)
...
//
#define PDH_MORE_DATA                    ((unsigned long)0x800007D2L)
...
//
#define PDH_CSTATUS_ITEM_NOT_VALIDATED   ((unsigned long)0x800007D3L)
...
//
#define PDH_RETRY                        ((unsigned long)0x800007D4L)
...
//  No data to return.
//
#define PDH_NO_DATA                      ((unsigned long)0x800007D5L)
...
//
#define PDH_CALC_NEGATIVE_DENOMINATOR    ((unsigned long)0x800007D6L)
...
//
#define PDH_CALC_NEGATIVE_TIMEBASE       ((unsigned long)0x800007D7L)
...
//
#define PDH_CALC_NEGATIVE_VALUE          ((unsigned long)0x800007D8L)
...
//
#define PDH_DIALOG_CANCELLED             ((unsigned long)0x800007D9L)
...
//
#define PDH_CSTATUS_NO_OBJECT            ((unsigned long)0xC0000BB8L)
...
//
#define PDH_CSTATUS_NO_COUNTER           ((unsigned long)0xC0000BB9L)
...
//
#define PDH_CSTATUS_INVALID_DATA         ((unsigned long)0xC0000BBAL)
...
//  function.
//
#define PDH_MEMORY_ALLOCATION_FAILURE    ((unsigned long)0xC0000BBBL)
...
//
#define PDH_INVALID_HANDLE               ((unsigned long)0xC0000BBCL)
...
//
#define PDH_INVALID_ARGUMENT             ((unsigned long)0xC0000BBDL)
...
//
#define PDH_FUNCTION_NOT_FOUND           ((unsigned long)0xC0000BBEL)
...
//
#define PDH_CSTATUS_NO_COUNTERNAME       ((unsigned long)0xC0000BBFL)
...
//  specified path.
//
#define PDH_CSTATUS_BAD_COUNTERNAME      ((unsigned long)0xC0000BC0L)
...
//
#define PDH_INVALID_BUFFER               ((unsigned long)0xC0000BC1L)
...
//  requested data.
//
#define PDH_INSUFFICIENT_BUFFER          ((unsigned long)0xC0000BC2L)
...
//
#define PDH_CANNOT_CONNECT_MACHINE       ((unsigned long)0xC0000BC3L)
...
//
#define PDH_INVALID_PATH                 ((unsigned long)0xC0000BC4L)
...
//
#define PDH_INVALID_INSTANCE             ((unsigned long)0xC0000BC5L)
...
//
#define PDH_INVALID_DATA                 ((unsigned long)0xC0000BC6L)
...
//
#define PDH_NO_DIALOG_DATA               ((unsigned long)0xC0000BC7L)
...
//
#define PDH_CANNOT_READ_NAME_STRINGS     ((unsigned long)0xC0000BC8L)

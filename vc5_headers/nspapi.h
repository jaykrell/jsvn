...
typedef struct _NS_INFOA {
    ...
    unsigned long dwNameSpaceFlags ;
    LPSTR   lpNameSpace ;
...
typedef struct _SERVICE_TYPE_VALUE {
    ...
    unsigned long dwValueNameOffset ;
...
typedef struct _SERVICE_TYPE_INFO {
    unsigned long dwTypeNameOffset ;
    unsigned long dwValueCount ;
...
typedef struct _SERVICE_ADDRESS {
    unsigned long   dwAddressType ;
    unsigned long   dwAddressFlags ;
    unsigned long   dwAddressLength ;
    unsigned long   dwPrincipalLength ;
#ifdef MIDL_PASS
...
typedef  unsigned long (* LPFN_NSPAPI) (VOID ) ;

...
BOOL WINAPI DllMain(HANDLE, unsigned long, void*);
BOOL WINAPI _CRT_INIT(HANDLE, unsigned long, void*);
BOOL WINAPI _wCRT_INIT(HANDLE, unsigned long, void*);
extern BOOL (WINAPI *_pRawDllMain)(HANDLE, unsigned long, void*);
#else

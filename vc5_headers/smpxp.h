...
#define PR_SAMPLE_FLAG_PEER_TO_PEER ((unsigned long) 0x00000001)
#define PR_SAMPLE_FLAG_UI_ALWAYS    ((unsigned long) 0x00000002)
#define PR_SAMPLE_FLAG_LOG_EVENTS   ((unsigned long) 0x00000004)
#define PR_SAMPLE_FLAG_SAVE_DATA    ((unsigned long) 0x00000008)

...
public:
	...
	//
	explicit _com_ptr_t(const CLSID& clsid, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw(_com_error)
		: m_pInterface(NULL)
	{
	...
	// the string.
	//
	explicit _com_ptr_t(LPOLESTR str, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw(_com_error)
		: m_pInterface(NULL)
	{
	...
	// the string.
	//
	explicit _com_ptr_t(const char* str, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw(_com_error)
		: m_pInterface(NULL)
	{
		HRESULT hr = CreateInstance(str, pOuter, dwClsContext);
	...
	//
	HRESULT CreateInstance(const CLSID& rclsid, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw()
	{
		HRESULT hr;
	...
	//
	HRESULT CreateInstance(LPOLESTR clsidString, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw()
	{
		if (clsidString == NULL) {
			return E_INVALIDARG;
		}
	...
	// contain a class id, or a prog id string.
	//
	HRESULT CreateInstance(const char* clsidStringA, IUnknown* pOuter = NULL, unsigned long dwClsContext = CLSCTX_ALL) throw()
	{
	...
	// First convert the const char* to a LPOLESTR.
	//
	HRESULT GetActiveObject(const char* clsidStringA) throw()
	{
		if (clsidStringA == NULL) {
			return E_INVALIDARG;
		}

...
public:
    ...
    virtual void WriteBlock(LPCTSTR pBlock, unsigned long dwSize) = 0;
};
...
public:
	...
	virtual LPCTSTR LoadTemplate(LPCTSTR lpszTemplateName,
		unsigned long& rdwSize, HINSTANCE hInstance = NULL);

	virtual void CopyTemplate(LPCTSTR lpszInput, unsigned long dwSize, OutputStream* pOutput);
	virtual void ProcessTemplate(LPCTSTR lpszInput, unsigned long dwSize, OutputStream* pOutput);

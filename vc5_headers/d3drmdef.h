...
typedef void (*D3DRMWRAPCALLBACK)
    (LPD3DVECTOR, int* u, int* v, LPD3DVECTOR a, LPD3DVECTOR b, void*);
...
typedef unsigned long D3DRMRENDERQUALITY, *LPD3DRMRENDERQUALITY;
...
typedef unsigned long D3DRMSAVEOPTIONS;
...
typedef unsigned long D3DRMANIMATIONOPTIONS;
...
typedef unsigned long D3DRMLOADOPTIONS;
...
typedef unsigned long D3DRMMAPPING, D3DRMMAPPINGFLAG, *LPD3DRMMAPPING;

...
typedef struct _PERF_DATA_BLOCK {
    ...
    unsigned long           LittleEndian;       // 0 = Big Endian, 1 = Little Endian
    unsigned long           Version;            // Version of these data structures
                                        // starting at 1
    unsigned long           Revision;           // Revision of these data structures
                                        // starting at 0 for each Version
    unsigned long           TotalByteLength;    // Total length of data block
    unsigned long           HeaderLength;       // Length of this structure
    unsigned long           NumObjectTypes;     // Number of types of objects
                                        // being reported
    ...
    unsigned long           SystemNameLength;   // Length of the system name
    unsigned long           SystemNameOffset;   // Offset, from beginning of this
...
typedef struct _PERF_OBJECT_TYPE {
    unsigned long           TotalByteLength;    // Length of this object definition
                                        ...
                                        // any
    unsigned long           DefinitionLength;   // Length of object definition,
                                        ...
                                        // no instance
    unsigned long           HeaderLength;       // Length of this structure: this
                                        // is the offset to the first
                                        // counter definition for this
                                        // object
    unsigned long           ObjectNameTitleIndex;
                                        // Index to name in Title Database
    LPWSTR          ObjectNameTitle;    // Initially NULL, for use by
                                        // analysis program to point to
                                        // retrieved title string
    unsigned long           ObjectHelpTitleIndex;
                                        // Index to Help in Title Database
    LPWSTR          ObjectHelpTitle;    // Initially NULL, for use by
                                        // analysis program to point to
                                        // retrieved title string
    unsigned long           DetailLevel;        // Object level of detail (for
                                        // controlling display complexity);
                                        // will be min of detail levels
                                        // for all this object's counters
    unsigned long           NumCounters;        // Number of counters in each
    ...
    LONG            NumInstances;       // Number of object instances
                                        ...
                                        // this counter.
    unsigned long           CodePage;           // 0 if instance strings are in
...
typedef struct _PERF_COUNTER_DEFINITION {
    unsigned long           ByteLength;         // Length in bytes of this structure
    unsigned long           CounterNameTitleIndex;
                                        // Index of Counter name into
                                        // Title Database
    LPWSTR          CounterNameTitle;   // Initially NULL, for use by
                                        // analysis program to point to
                                        // retrieved title string
    unsigned long           CounterHelpTitleIndex;
    ...
    LONG            DefaultScale;       // Power of 10 by which to scale
                                        ...
                                        // 0 ==> 1, 1 ==> 10, -1 ==>1/10, etc.
    unsigned long           DetailLevel;        // Counter level of detail (for
                                        // controlling display complexity)
    unsigned long           CounterType;        // Type of counter
    unsigned long           CounterSize;        // Size of counter in bytes
    unsigned long           CounterOffset;      // Offset from the start of the
...
typedef struct _PERF_INSTANCE_DEFINITION {
    ...
    unsigned long           ParentObjectTitleIndex;
                                        // Title Index to name of "parent"
                                        // object (e.g., if thread, then
                                        // process is parent object type);
                                        // if logical drive, the physical
                                        // drive is parent object type
    unsigned long           ParentObjectInstance;
    ...
    unsigned long           NameOffset;         // Offset from beginning of
                                        // this struct to the Unicode name
                                        // of this instance
    unsigned long           NameLength;         // Length in bytes of name; 0 = none
...
//
typedef unsigned long (APIENTRY PM_OPEN_PROC) (LPWSTR);
typedef unsigned long (APIENTRY PM_COLLECT_PROC) (LPWSTR, void* *, LPDWORD, LPDWORD);
typedef unsigned long (APIENTRY PM_CLOSE_PROC) (void);
